...
import { NextList, NextListButtonItem, NextListDivider } from "seed-design/ui/next-list";
...
const meta = {
  component: NextListButtonItem,
  decorators: [SeedThemeDecorator],
} satisfies Meta<typeof NextListButtonItem>;
