...
import { NextList, NextListLinkItem, NextListDivider } from "seed-design/ui/next-list";
...
const meta = {
  component: NextListLinkItem,
  decorators: [SeedThemeDecorator],
} satisfies Meta<typeof NextListLinkItem>;
