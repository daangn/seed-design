...
function ShareButtonContent({ title }: { title: string }) {
  ...
  return (
    <span className="relative inline-flex">
      ...
      <span className="pointer-events-none absolute bottom-full left-1/2 mb-1 -translate-x-1/2 whitespace-nowrap rounded-r1 bg-bg-neutral-solid px-x2 py-x1 text-sm text-fg-on-neutral-solid opacity-0 transition-opacity peer-hover:opacity-100">
        공유하기
      </span>
    </span>
  );
