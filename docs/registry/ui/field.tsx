...
import { Field as SeedField } from "@seed-design/react";
import * as React from "react";

export interface FieldRequiredIndicatorProps extends React.SVGProps<SVGSVGElement> {}

export const FieldRequiredIndicator = React.forwardRef<SVGSVGElement, FieldRequiredIndicatorProps>(
  (props, ref) => {
    return (
      <SeedField.RequiredIndicator
        svg={
          <svg
            width="6"
            height="6"
