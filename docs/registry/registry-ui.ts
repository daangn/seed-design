  ...
  items: [
    {
      ...
      snippets: [
        {
          path: "app-screen.tsx",
          dependencies: { "@ride-developer/react": "~1.0.0", "@ride-developer/css": "~1.0.0" },
        },
        {
          path: "app-bar.tsx",
          dependencies: { "@ride-developer/react": "~1.0.0", "@ride-developer/css": "~1.0.0" },
      ...
      snippets: [
        {
          ...
          dependencies: { "@ride-developer/react": "~1.1.0", "@ride-developer/css": "~1.1.0" },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      snippets: [
        {
          path: "checkbox.tsx",
          dependencies: { "@ride-developer/react": "~1.2.0", "@ride-developer/css": "~1.2.0" },
        },
      ],
    },
    {
      ...
      snippets: [
        {
          ...
          dependencies: { "@ride-developer/react": "~1.3.0", "@ride-developer/css": "~1.3.0" },
        },
      ],
    },
    {
