...
declare namespace GatsbyTypes {
  ...
  type File = Node & {
    ...
    readonly childrenComponentMetaJson: Maybe<
      ReadonlyArray<Maybe<componentMetaJson>>
    >;
    ...
    readonly childrenPrimitiveMetaJson: Maybe<
      ReadonlyArray<Maybe<primitiveMetaJson>>
    >;
    readonly ctime: Scalars["Date"];
    readonly ctimeMs: Scalars["Float"];
    readonly dev: Scalars["Int"];
  ...
  type ColorSystemPageQuery = {
    readonly system: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly scaleToken1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly scaleToken2: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly semanticToken1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly semanticToken2: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly staticToken1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
  ...
  type ColorUsagePageQuery = {
    ...
    readonly interactive1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly interactiveDont1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly interactiveDo1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    ...
    readonly combiningDont1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
    readonly combiningDo1: {
      readonly childImageSharp: {
        readonly gatsbyImageData: import("gatsby-plugin-image").IGatsbyImageData;
      } | null;
    } | null;
  ...
  type ComponentListPageQuery = {
    readonly allComponentMetaJson: {
  ...
  type ComponentOverviewQuery = {
    readonly componentMetaJson: {
      readonly name: string | null;
      readonly description: string | null;
      readonly platform: {
        readonly ios: {
        ...
        readonly docs: {
          readonly overview: {
            ...
            readonly mdx: {
              readonly childMdx: {
                readonly tableOfContents: any | null;
              } | null;
            } | null;
          } | null;
        } | null;
      ...
      readonly primitive: {
        readonly childPrimitiveMetaJson: {
          readonly primitive: {
            readonly childMdx: {
              readonly frontmatter: { readonly slug: string | null } | null;
            } | null;
  ...
  type ComponentProgressBoardPageQueryVariables = Exact<{
    [key: string]: never;
  }>;

  type ComponentProgressBoardPageQuery = {
    readonly allComponentMetaJson: {
      readonly nodes: ReadonlyArray<{
        readonly name: string | null;
        readonly description: string | null;
  ...
  type PrimitiveListPageQuery = {
    readonly allPrimitiveMetaJson: {
      readonly nodes: ReadonlyArray<{
        readonly name: string | null;
        readonly description: string | null;
        readonly thumbnail: {
  ...
  type SEOQuery = {
    ...
    readonly blackFavicon: { readonly publicURL: string | null } | null;
    readonly whiteFavicon: { readonly publicURL: string | null } | null;
  };
