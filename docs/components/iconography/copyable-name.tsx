...
export const CopyableName = React.forwardRef<HTMLButtonElement, CopyableNameProps>(
  function CopyableName({ name, label, className }, ref) {
...
CopyableName.displayName = "CopyableName";
