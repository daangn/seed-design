  ...
  return (
    <VStack gap="spacingY.componentDefault" width="full">
      <Field.Root size="medium">
        ...
        <TextFieldInput textareaProps={{ placeholder: "플레이스홀더" }} size="medium" />
      </Field.Root>
      <Field.Root size="large">
        <Field.Header>
          <Field.Label>Large Text Field</Field.Label>
        </Field.Header>
        <TextFieldInput textareaProps={{ placeholder: "플레이스홀더" }} size="large" />
      </Field.Root>
      <Field.Root size="xlarge">
        <Field.Header>
          <Field.Label>XLarge Text Field</Field.Label>
        </Field.Header>
        <TextFieldInput textareaProps={{ placeholder: "플레이스홀더" }} size="xlarge" />
      </Field.Root>
    </VStack>
  );
}
