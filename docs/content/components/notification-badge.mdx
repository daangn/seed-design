...
whenToRead: Notification Badge를 점(Small)과 숫자(Large) 중 무엇으로 표시할지, 최대 4자 라벨·0 미표시, 확인 후 사라지는 동작, 남용 기준 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["알림 배지"]
coverImage: /og/components/notification-badge
---
