...
whenToRead: 삭제·이탈처럼 확인이나 경고가 필요한 순간의 버튼 배열, Critical·Nonpreferred 레이아웃, 문구 작성, Menu Sheet와의 구분 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["얼럿 다이얼로그", "알럿 다이얼로그"]
coverImage: /og/components/alert-dialog
---
