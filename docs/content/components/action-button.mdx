...
whenToRead: 버튼 variant를 강조 위계(High·Medium·Low)에 맞춰 고르거나 size, 버튼 조합·배치, 라벨·아이콘 사용, Chip과의 구분 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["액션 버튼"]
coverImage: /og/components/action-button
---
...
| **Critical Solid**  | 삭제나 초기화처럼 되돌릴 수 없는 중요한 작업에 사용합니다. 사용자에게 위험을 분명하게 알려주는 역할을 하며, 주로 [Alert Dialog](/components/alert-dialog)에서 사용됩니다.                          |
...
<Card
  href="/updates/whats-new-in-action-button"
