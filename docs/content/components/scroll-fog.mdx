...
whenToRead: 스크롤 영역 가장자리 페이드의 top·bottom·left·right placement, 방향별 권장 크기(하단 80px·상단 20px 등), Fog 깊이와 콘텐츠 padding의 관계 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["스크롤 포그"]
coverImage: /og/components/scroll-fog
---
