...
whenToRead: 로딩 중 콘텐츠 윤곽을 그릴 때 유형별 radius(텍스트 8, 카드 16, 원형 Avatar 9999), AI 콘텐츠용 magic tone, Progress Circle과의 구분 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["스켈레톤"]
coverImage: /og/components/skeleton
---
...
| **텍스트**                                   | 8      |
| **카드 및 썸네일**                           | 16     |
| **[Avatar](/components/avatar) (원형)** | 9999   |
