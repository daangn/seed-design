...
whenToRead: Inset·Full-width Divider와 8px Gap 중 무엇으로 구분할지, Neutral Muted·Subtle tone, 세로 방향, 마지막 구분선 생략 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["구분선"]
coverImage: /og/components/divider
---
