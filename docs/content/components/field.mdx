...
whenToRead: 입력 UI에 Label·필수 표시·Helper Text·Error Message를 붙이는 방식이나 제출 시·인라인 검증, 이탈 시 경고, 단일 화면·단계별 Form 구성 같은 폼 디자인 기준이 필요할 때 읽는다.
keywords: ["필드"]
coverImage: /og/components/field
---
...
<Card href="/components/text-input" title="Text Field">
  Text Input을 포함한 Field
</Card>
<Card href="/components/text-input#textarea" title="Textarea Field">
  Textarea를 포함한 Field
</Card>
<Card href="/components/checkbox" title="Checkbox Group Field">
  Checkbox Group을 포함한 Field
</Card>
<Card href="/components/radio" title="Radio Group Field">
  Radio Group을 포함한 Field
</Card>
<Card href="/components/select-box" title="Select Box Group Field">
  Select Box Group을 포함한 Field
</Card>
<Card href="/components/select" title="Select Field">
  Select를 포함한 Field
</Card>
<Card href="/components/slider" title="Slider Field">
  Slider를 포함한 Field
</Card>
<Card href="/components/input-button" title="Field Button">
