...
whenToRead: 페이지 최상단에 상태·제재·기능 안내를 둘 때 tone과 Weak·Solid 조합, 한 화면 하나·상단 고정 규칙, Dismissible·진입점 활용, Callout과의 구분 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["페이지 배너"]
coverImage: /og/components/page-banner
---
...
<ComponentSpecBlock id="page-banner" headingComponent="h4" />

### Page Banner Close Button

<ComponentSpecBlock id="page-banner-close-button" headingComponent="h4" />
