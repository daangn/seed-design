...
whenToRead: 본문 중간에 팁·주의 메시지를 넣을 때 Display·Actionable·Dismissible 동작, tone, 제목·Link Text 작성 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["콜아웃"]
coverImage: /og/components/callout
---
...
<ComponentSpecBlock id="callout" headingComponent="h4" />

### Callout Close Button

<ComponentSpecBlock id="callout-close-button" headingComponent="h4" />
