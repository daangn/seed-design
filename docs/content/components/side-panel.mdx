...
whenToRead: 측면 패널의 좌·우 방향, Small·Medium·Large 폭, Modal·Persistent 타입, md 미만 너비·Bottom Sheet 전환, 모바일 내비게이션 통합 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["사이드 패널"]
coverImage: /og/components/side-panel
---
...
<Card href="/components/bottom-sheet" title="Bottom Sheet와 함께">
  데스크탑에서는 기본적으로 Responsive Side Panel을 사용해, md 미만에서 Bottom
...
<FigmaImage
  id="2104:10721"
  alt="Breakpoint에 따른 Side Panel 너비 - md 이상은 Width 토큰값, md 미만은 화면 너비의 80%"
/>
...
<FigmaImage
  id="2104:10793"
  alt="Responsive Side Panel - md 이상에서는 Side Panel, md 미만에서는 Bottom Sheet로 표시"
/>

데스크탑에서 Side Panel을 사용하는 경우, 기본적으로 Responsive Side Panel을 사용합니다. md 이상에서는 Side Panel, md 미만에서는 [Bottom Sheet](/components/bottom-sheet)로 자동 전환되어 각 환경에 적합한 사용성을 제공합니다.
