...
whenToRead: Slider의 Single·Range 핸들, 연속형·이산형 Tick Mark와 Markers, Active Track 표시, 기본값·현재 값 표시와 Value Indicator 오버플로우 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["슬라이더"]
coverImage: /og/components/slider
---
