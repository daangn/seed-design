---
slug: /components/spec/style/toggle-button
title: Toggle Button
...
![button style anatomy](./button-style-anatomy.png)
...
### Variant=Primary & isSelected=True

| State    | Part        | Attribute | Value                         |
| -------- | ----------- | --------- | ----------------------------- |
| Enabled  | Root        | Color     | $semantic.color.secondary-low |
|          | Label, Icon | Color     | $scale.color.gray-900         |
| Hovered  | Root        | Color     | $scale.color.gray-200         |
|          | Label, Icon | Color     | $scale.color.gray-900         |
...
### Variant=Primary & isSelected=False
...
### Variant=Primary Low & isSelected=True
...
### Variant=Primary Low & isSelected=False
...
### Variant=Secondary & isSelected=True
...
### Variant=Secondary & isSelected=False
