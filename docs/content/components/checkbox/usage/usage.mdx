...
<Table>
  <TableHead>
    <TableRow>
      <TableData>속성</TableData>
      <TableData>값</TableData>
      <TableData>기본값</TableData>
      <TableData>설명</TableData>
    </TableRow>
  </TableHead>
  <TableBody>
    <TableRow>
      <TableData>label</TableData>
      <TableData>text | none</TableData>
      <TableData>-</TableData>
      <TableData></TableData>
    </TableRow>
    <TableRow>
      <TableData>size</TableData>
      <TableData>small | medium | large</TableData>
