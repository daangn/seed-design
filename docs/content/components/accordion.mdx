...
whenToRead: Accordion을 쓸지 판단하고 Item 최소 개수, 모바일(Medium)·PC(Large) 사이즈, 펼칠 때 자동 스크롤·포커스 이동, Content Panel 내부 스크롤 지양 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["아코디언"]
coverImage: /og/components/accordion
---
...
<Grid>
  <FigmaImage id="1030:18296" alt="Single Expand 사용 예시" />
  <FigmaImage id="1030:18323" alt="Multi Expand 사용 예시" />
</Grid>
