...
whenToRead: 상태·카테고리 라벨로 쓸 Badge의 tone과 Solid·Outline·Weak 스타일 선택, 개수·라벨 길이 제한, 클릭 요소로 쓰지 않기 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["배지"]
coverImage: /og/components/badge
---
...
액션이 필요한 경우엔 [Chip](/components/chip), Toggle Button, 또는 [Action Button](/components/action-button) 컴포넌트를 사용해주세요.
