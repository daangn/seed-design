...
whenToRead: 카드·상세·프로필의 부가 정보를 Tag Group으로 묶을 때 t2~t4 사이즈, Item별 tone·weight·아이콘 조합, 6~10자 문구, 우선순위·줄바꿈 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["태그 그룹"]
coverImage: /og/components/tag-group
---
