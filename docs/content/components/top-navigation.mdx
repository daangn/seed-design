...
whenToRead: 상단 바의 Root·Standard 타입 선택, 뒤로가기와 닫기 구분, History·Hierarchy Back 정책, 우측 아이콘 버튼 개수(최대 3개), 스크롤 시 동작 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["탑 네비게이션", "앱바", "appbar"]
coverImage: /og/components/top-navigation
---
