...
whenToRead: 완료·실패·빈 상태 화면의 Large·Medium 사이즈, Lottie·아이콘 에셋, Bottom CTA와 내부 버튼의 위계, 실패 시 뒤로가기·닫기 선택 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["엠티 스테이트", "empty state"]
coverImage: /og/components/result-section
---
...
최상위 레이아웃에 적용 시 콘텐츠가 화면 정중앙에 위치합니다.
...
<Grid>
  ...
  <DontImage
    ...
    alt="가입 보류 메시지와 함께 3D 에셋을 사용한 예시"
  />
</Grid>
