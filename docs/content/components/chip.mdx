...
whenToRead: Chip을 Selection·Suggestion·Input·Filter Bar 중 어떤 용도로 쓸지, variant·size와 Chip Group 레이아웃(Scrollable·Overflow)을 정하는 디자인 기준이 필요할 때 읽는다.
keywords: ["칩"]
coverImage: /og/components/chip
---
