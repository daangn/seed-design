...
whenToRead: 로딩 표시에 Indeterminate·Determinate 중 무엇을 쓸지, 24·40 사이즈와 tone, 배경에 묻힐 때의 Overlay, 위치로 로딩 범위를 나타내는 법 같은 디자인 기준이 필요할 때 읽는다.
keywords: ["프로그레스 서클"]
coverImage: /og/components/progress-circle
---
