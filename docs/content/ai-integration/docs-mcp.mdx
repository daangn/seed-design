...
[`@seed-design/docs-mcp`](https://github.com/daangn/seed-design/tree/dev/packages/docs-mcp)는 SEED Design 문서를 위한 공식 MCP(Model Context Protocol) 서버입니다.
...
> 참고: SEED Design 문서 사이트의 내장 AI 패널은 `@ai-sdk/mcp` 기반 MCP client를 사용해 `docs-mcp` 도구를 호출합니다.
