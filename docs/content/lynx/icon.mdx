---
title: Icon
description: Lynx 아이콘 패키지 설치 및 사용 방법
---
...
export function App(props: {
  ...
  return (
    <view>
      ...
      <IconAUppercaseALowercaseFill size={40} color='gray' />
      <IconArrow2ClockwiseCircularLine size={60} color='gray' />
      <IconArrow2ClockwiseCircularFill size={60} color='gray' />
