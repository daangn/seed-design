...
<LynxComponentExample name="lynx/radio-group/preview">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/preview.tsx", "codeblock": true }
  ```
...
<LynxComponentExample name="lynx/radio-group/size">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/size.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
<LynxComponentExample name="lynx/radio-group/brand">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/brand.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
<LynxComponentExample name="lynx/radio-group/neutral">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/neutral.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
<LynxComponentExample name="lynx/radio-group/long-label">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/long-label.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
<LynxComponentExample name="lynx/radio-group/disabled">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/disabled.tsx", "codeblock": true }
  ```
</LynxComponentExample>

### Listening to Value Changes

`onValueChange`로 선택 값 변경을 감지할 수 있습니다.

<LynxComponentExample name="lynx/radio-group/value-changes">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/value-changes.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
`RadioGroup.ItemControl`과 `RadioGroup.ItemIndicator`를 직접 조합하면 마크와 레이블 배치를 자유롭게 구성할 수 있습니다.

<LynxComponentExample name="lynx/radio-group/radiomark">
  ```json doc-gen:file
  { "file": "examples/lynx/radio-group/radiomark.tsx", "codeblock": true }
  ```
</LynxComponentExample>
...
React 문서의 **Weights** 예제는 Lynx에서 `weight`를 그룹 전체에만 지정할 수 있어 항목별 비교를 재현할 수 없으므로 제외했습니다. **React Hook Form**과 **RadioGroupField Integration** 예제는 HTML form 제출과 hidden input이 필요하므로 제외했습니다.
