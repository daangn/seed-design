...
Accordion Trigger는 화면 폭과 배경 정렬을 유지하기 위해 **Content Scale**을 사용합니다. 눌렀을 때 pressed overlay는 제자리에 남고 Prefix, Body, Suffix Icon이 들어 있는 내부 content layer만 줄어듭니다. [Scale Feedback](/lynx/components/concepts/scale-feedback)에서 Self와 Content의 차이를 확인하세요.
