...
- **Content transition**: 임의 높이를 측정하는 웹 방식의 expand/collapse 애니메이션은 제공하지 않습니다. 콘텐츠는 열림 상태에 따라 즉시 표시되고 suffix 아이콘 회전은 유지됩니다.
</Callout>
...
| 높이 기반 펼침 애니메이션 | 임의 콘텐츠 높이를 CSS 변수로 측정하는 웹 구현을 사용하지 않습니다. |
