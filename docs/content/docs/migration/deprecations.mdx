...
| $color.bg.layer-fill                   | 디자인 토큰   | 1.2.x           | 2.0.0          | $color.bg.neutral-weak | 더이상 사용하지 않음 (elevation 문서 안내)                   |
| $gradient.fade-layer-floating          | 디자인 토큰   | 1.2.x           | 2.0.0          | -                      | 대체안 미정                                                  |
| $gradient.fade-layer-default           | 디자인 토큰   | 1.2.x           | 2.0.0          | -                      | 대체안 미정                                                  |
