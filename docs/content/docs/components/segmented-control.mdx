...
<FigmaImage id="" alt="한 화면에 한 개만 사용하는 예시" />
...
<FigmaImage id="" alt="Segmented Control과 Tabs 비교 표" />
...
<FigmaImage id="" alt="Segmented Control과 Tabs 비교 예시 이미지" />
