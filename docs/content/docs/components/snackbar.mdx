...
<FigmaImage id="" alt="Snackbar의 Action Property - Text 버튼" />
...
<FigmaImage id="" alt="Snackbar 사용 예시" />
...
<FigmaImage
  id=""
  alt="Snackbar 위치와 레이아웃 - Safe Area, 여백, FAB와의 관계"
/>
...
<FigmaImage id="" alt="Snackbar 내용 작성 예시 - 좋은 예와 나쁜 예" />
...
<FigmaImage id="" alt="Snackbar 동작 - 5초 후 자동 닫힘, 터치 시 일시정지" />
...
<FigmaImage id="" alt="Snackbar 액션 사용 예시 - 구체적인 액션 라벨" />
...
<FigmaImage id="" alt="Snackbar V2와 V3 비교 Playground" />
