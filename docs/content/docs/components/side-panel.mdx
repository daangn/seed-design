...
<Card href="/docs/components/bottom-sheet" title="Bottom Sheet와 함께">
  데스크탑에서는 기본적으로 Responsive Side Panel을 사용해, sm 이하에서 Bottom
  Sheet로 자동 전환합니다. 화면 하단에서 올라오는 모달이 필요하다면 Bottom
  Sheet를 사용하세요.
</Card>
...
<FigmaImage
  id="2104:10657"
  alt="Side Panel의 Anatomy. Backdrop 위에 패널이 있고, 패널은 Header(Title, Description, Close Button), Body, Footer로 구성됩니다."
/>
...
<FigmaImage
  id="2104:10673"
  alt="Side Panel의 Direction Property - Right, Left"
/>
...
<FigmaImage
  id="2104:10688"
  alt="Side Panel의 Size Property - Small 480px, Medium 720px, Large 960px"
/>
...
<FigmaImage
  id="2104:10706"
  alt="Side Panel의 Type - Modal Drawer, Persistent Drawer"
/>
...
<FigmaImage
  id="2104:10721"
  alt="Breakpoint에 따른 Side Panel 너비 - md 이상은 Width 토큰값, sm 이하는 화면 너비의 80%"
/>
...
<FigmaImage
  id="2104:10750"
  alt="데스크탑에서 분리된 Side Nav와 Header 메뉴가 모바일에서 하나의 Side Panel로 통합되는 모습"
/>
...
<FigmaImage
  id="2104:10793"
  alt="Responsive Side Panel - md 이상에서는 Side Panel, sm 이하에서는 Bottom Sheet로 표시"
/>
...
<FigmaImage
  id="2104:10809"
  alt="Side Panel의 Elevation - 메인 화면(Level 1) 위, Dialog(Level 3) 아래의 Level 2 계층"
/>
