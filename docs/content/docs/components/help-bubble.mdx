...
<FigmaImage id="" alt="Help Bubble의 Placement Property - 다양한 위치 옵션" />
...
<FigmaImage
  id=""
  alt="Help Bubble의 모든 Placement 예시 - Bottom-Left, Top-Left, Right-Top, Left-Top, Right-Center, Left-Center, Right-Bottom, Left-Bottom, Bottom-Center, Top-Center, Bottom-Right, Top-Right"
/>
...
<FigmaImage id="" alt="Close Button Target Size - 38*38px의 터치 영역" />

Close Button Target Size: 38\*38

### Show Description

<FigmaImage id="" alt="Help Bubble의 Show Description Property" />
...
<FigmaImage
  id=""
  alt="Help Bubble이 화면에서 Overflow 되는 경우의 위치 조정 예시"
/>
...
<FigmaImage id="" alt="Help Bubble을 여는 방법 - Trigger 요소 탭" />

Help Bubble은 Trigger 요소를 탭했을 때 표시되거나, 처음부터 표시된 상태로 존재할 수 있습니다.

<FigmaImage
  id=""
  alt="Help Bubble을 닫는 방법 - Trigger 재탭 또는 Close Button 탭"
/>
...
<FigmaImage id="" alt="Help Bubble V2와 V3 비교 Playground" />
