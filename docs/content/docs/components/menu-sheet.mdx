...
<FigmaImage id="" alt="Menu Sheet의 Anatomy 이미지" />
...
<FigmaImage id="" alt="Menu Sheet의 Menu Group Count Property" />
...
<FigmaImage id="" alt="Menu Sheet의 Menu Item Tone - Neutral과 Critical" />
...
**Text Only와 Text with Icon 아이템을 함께 사용할 수 없습니다.**

### 메뉴 그룹

<FigmaImage id="" alt="Menu Sheet의 메뉴 그룹 사용 예시" />
...
<FigmaImage id="" alt="Menu Sheet에서 Critical Tone 사용 예시" />
...
<FigmaImage id="" alt="Menu Sheet에서 Header 사용 예시" />
...
<FigmaImage id="" alt="Menu Sheet에서 Item Description 사용 예시" />
...
<FigmaImage id="" alt="Menu Sheet V2와 V3 비교 Playground" />
