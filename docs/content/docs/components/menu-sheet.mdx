---
title: Menu Sheet
description: Menu Sheet는 사용자의 작업과 관련된 선택지를 제공하는 시트 형태의 컴포넌트입니다.
...
<FigmaImage id="2:142975" alt="Menu Sheet의 Menu Item Tone - Neutral과 Critical" />
...
메뉴 아이템의 액션 설명(description)은 'Show Item Description' prop (on/off)을 이용해 제어할 수 있습니다. 다만, 이 prop은 모든 아이템에 공통으로 사용되는 경우가 잘 없기에 사용할 리스트 아이템을 클릭하여 Properties 패널에서 설정을 확인해 주세요.
...
<DontImage figmaId="2:143052" body="Text Only와 Text with Icon을 함께 사용할 수 없습니다." alt="하나의 Menu Sheet에서 Text Only와 Text with Icon을 함께 사용한 경우" />
...
<DontImage figmaId="2:143070" body="적어도 하나의 그룹은 2개 이상의 아이템을 포함해야 합니다." alt="모든 메뉴 그룹에 아이템이 1개만 포함된 경우" />
...
- Desctrctive 타입을 삭제했으며, Critical Tone은 개별 아이템에서 설정할 수 있도록 변경했습니다.
...
<ComponentSpecBlock id="menu-sheet-item" />

### Menu Sheet Close Button

<ComponentSpecBlock id="menu-sheet-close-button" />
