...
<FigmaImage
  id=""
  alt="Alert Dialog의 Layout Property - Action Button 가로 배열과 세로 배열"
/>
...
<FigmaImage id="" alt="Alert Dialog의 Show Title Property - 제목 표시 여부" />
...
<FigmaImage
  id=""
  alt="Alert Dialog를 알림 또는 확인이 필요한 상황에서 사용하는 예시 - Neutral과 Brand"
/>
...
<FigmaImage id="" alt="Alert Dialog UX Writing 문서 링크" />
...
<FigmaImage id="" alt="Alert Dialog와 Menu Sheet 사용 예시 비교" />
