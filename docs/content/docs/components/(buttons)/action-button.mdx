...
{/* do/dont 규범은 packages/guidelines/component/action-button.yaml(SSOT)에 정의하고, 문서에서는 <GuidelineRef id> 로 인용한다. 이미지(figmaId)는 문서 렌더링 메타데이터로 여기서만 연결한다. */}
...
<GuidelineRef id="G-C-action-button-no-brand-color-overuse" figmaId="2:28889" />
...
<GuidelineRef id="G-C-action-button-up-to-two-side-by-side" figmaId="2:29133" />
<GuidelineRef id="G-C-action-button-no-three-side-by-side" figmaId="2:29220" />
...
<GuidelineRef id="G-C-action-button-label-action-centric" figmaId="2:29267" />
<GuidelineRef id="G-C-action-button-no-vague-label" figmaId="2:29282" />
...
<GuidelineRef id="G-C-action-button-icon-aids-meaning" />
<GuidelineRef id="G-C-action-button-no-dual-side-icons" figmaId="2:29805" />
...
이 선택 기준은 가이드라인으로도 관리됩니다:

<GuidelineRef id="G-C-action-button-chip-for-selection" />

## 더 알아보기

<Card
  href="/blog/whats-new-in-action-button"
