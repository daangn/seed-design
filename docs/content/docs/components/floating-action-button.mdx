...
<FigmaImage
  id=""
  alt="Floating Action Button의 Type - Button Type과 Menu Type"
/>
...
<FigmaImage id="" alt="Floating Action Button의 State - Enabled, Pressed" />

Floating Action Button은 Enabled, Pressed 상태를 가집니다.

### Extended Property

<FigmaImage id="" alt="Floating Action Button의 Extended Property" />

Extended Property를 켜면 텍스트를 표시할 수 있습니다. 이를 통해 기능을 텍스트로 명확히 표현하여 직관성을 높일 수 있습니다.

### Scroll Behavior

<FigmaImage id="" alt="Floating Action Button의 Scroll Behavior" />
...
<FigmaImage id="" alt="Floating Action Button 위치 가이드" />
...
<FigmaImage id="" alt="Floating Action Button V2와 V3 비교 Playground" />
