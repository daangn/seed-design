...
<FigmaImage
  id="2:132134"
  alt="Floating Action Button의 Type - Button Type"
/>

<FigmaImage
  id="2:132155"
  alt="Floating Action Button의 Type - Menu Type"
/>
...
Menu 타입은 Action Button에 여러 선택 옵션이 필요한 경우에 사용합니다.

Enabled 상태에서 두 타입의 형태가 동일하지만, 메뉴가 나타나는 동작이 다르므로 유의해서 사용해주세요.

### State

<FigmaImage id="2:132179" alt="Floating Action Button의 State - Enabled, Pressed" />
...
/>
<FigmaImage id="2:132273" alt="Floating Action Button이 화면 우측 하단에 위치한 예시" />
