...
<Card href="/docs/components/field" title="Field">
  Input Field를 Field 내부에서 사용하여 Select Field로 활용할 수 있습니다.
</Card>
...
<FigmaImage
  id="42:19782"
  alt="Input Button 활용 예시 - 바텀시트나 피커와 함께 사용"
/>

Input Button은 Input과 유사한 외형이지만 직접 값을 입력할 수 없는 버튼 컴포넌트입니다. 선택하면 바텀시트나 피커 등이 열려 값을 선택할 수 있으며, 선택이 완료되면 버튼 라벨에 해당 값이 표시됩니다.
