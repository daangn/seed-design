...
<FigmaImage id="" alt="List의 Single Line과 Multi Line Variants" />
...
<FigmaImage id="" alt="List의 Highlighted Property" />

List 컴포넌트의 Highlighted prop은 새로운 알림이나 업데이트처럼 사용자의 주목이 필요한 항목을 시각적으로 강조할 때 사용합니다.

### List State

<FigmaImage id="" alt="List의 State - Enable, Pressed, Disabled" />

List 컴포넌트는 Enable, Pressed, Disabled 같은 상태를 제공합니다.

### Prefix Property

<FigmaImage id="" alt="List의 Prefix Property" />
...
<FigmaImage id="" alt="List의 Suffix Property" />
...
<FigmaImage id="" alt="List의 Detail Property" />
...
<FigmaImage id="" alt="List와 List Item 사용 예시" />
...
<FigmaImage id="" alt="List Header로 묶어서 사용하는 예시" />

List를 그룹 단위로 묶어서 표현할 수 있도록 List Header 컴포넌트를 제공합니다.

### List Item 클리커블 사용하지 않기

<FigmaImage id="" alt="List Item 클리커블을 사용하지 않는 예시" />
...
<FigmaImage id="" alt="List Item 내부 간격 조정 예시" />
...
<FigmaImage id="" alt="List Item 클리커블 타겟 영역 예시" />
...
<FigmaImage id="" alt="Concentric Radius 예시" />
...
### Figma에서 List Item Child 사용하기

<FigmaImage id="" alt="Figma에서 List Item Child 사용 예시" />

List Title에는 Detach하지 않고 여러 요소를 조합할 수 있도록 Swap용 Child 컴포넌트가 숨겨져 있습니다.

### List Item을 Select로 Custom하기

<FigmaImage id="" alt="List Item을 Select로 Custom하는 예시" />
...
**Single Select(Radio)는 반드시 2개 이상 항목으로 구성되어야 합니다.**

**Single, Multi Select를 하나의 그룹에서 혼합해서 사용하지 마세요.**

## Spec

<ComponentSpecBlock id="list" />
