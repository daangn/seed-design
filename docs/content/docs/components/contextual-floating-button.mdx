...
<FigmaImage id="" alt="Contextual Floating Button 사용 예시" />
...
<FigmaImage id="" alt="Contextual Floating Button의 위치 예시" />

<FigmaImage id="" alt="Contextual Floating Button과 고정 요소와의 여백" />
...
<FigmaImage id="" alt="Contextual Floating Button의 Label 길이 예시" />
...
<FigmaImage id="" alt="Contextual Floating Button V2와 V3 비교 Playground" />
