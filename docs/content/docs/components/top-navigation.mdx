...
<FigmaImage
  id=""
  alt="Top Navigation Title Type - Root와 Standard의 Title 영역"
/>
...
<FigmaImage
  id=""
  alt="Top Navigation Right Slot - Icon Button과 Text Button 배치"
/>
...
<FigmaImage
  id=""
  alt="Top Navigation Notification Badge - Icon Button에 표시되는 Badge"
/>
...
<Grid>
  <DoImage
    figmaId=""
    alt="뒤로가기 사용 예시"
    body="2 Depth 게시글 상세 화면에서 Back Button 클릭 → 이전 피드 또는 추천 영역으로 이동"
  />
  <DoImage
    figmaId=""
    alt="닫기 사용 예시"
    body="글쓰기 화면에서 Close Button 클릭 → 최초 진입점으로 이동"
  />
</Grid>
...
<Grid>
  <DoImage
    figmaId=""
    alt="History Back 예시"
    body="게시글 상세 화면에서 Back Button 클릭 → 이전 게시글 상세 추천 목록으로 이동"
  />
  <DoImage
    figmaId=""
    alt="Hierarchy Back 예시"
    body="알림 수신 설정 화면에서 Back Button 클릭 → 상위 설정 화면으로 이동"
  />
</Grid>
