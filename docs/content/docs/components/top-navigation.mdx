...
<FigmaImage id="" alt="Top Navigation Anatomy - Root 타입과 Standard 타입" />

Top Navigation은 Root 타입과 Standard 타입, 두 가지로 나뉩니다. 각 타입은 별도의 구현체와 피그마 컴포넌트로 제공됩니다.

## Props

### Title Type

<FigmaImage id="" alt="Top Navigation Title Type - Root와 Standard의 Title 영역" />
...
<FigmaImage id="" alt="Top Navigation Left Slot - 뒤로가기와 닫기 버튼" />
...
<FigmaImage id="" alt="Top Navigation Right Slot - Icon Button과 Text Button 배치" />
...
<FigmaImage id="" alt="Top Navigation Notification Badge - Icon Button에 표시되는 Badge" />
...
<FigmaImage id="" alt="Root Top Navigation과 Standard Top Navigation 비교" />
...
<FigmaImage id="" alt="뒤로가기와 닫기 동작 비교" />
...
<Grid>
  <DoImage figmaId="" alt="뒤로가기 사용 예시" body="2 Depth 게시글 상세 화면에서 Back Button 클릭 → 이전 피드 또는 추천 영역으로 이동" />
  <DoImage figmaId="" alt="닫기 사용 예시" body="글쓰기 화면에서 Close Button 클릭 → 최초 진입점으로 이동" />
</Grid>

### 뒤로가기(Back)의 두 가지 동작: History Back vs Hierarchy Back

<FigmaImage id="" alt="History Back과 Hierarchy Back 비교" />
...
<Grid>
  <DoImage figmaId="" alt="History Back 예시" body="게시글 상세 화면에서 Back Button 클릭 → 이전 게시글 상세 추천 목록으로 이동" />
  <DoImage figmaId="" alt="Hierarchy Back 예시" body="알림 수신 설정 화면에서 Back Button 클릭 → 상위 설정 화면으로 이동" />
</Grid>

### 타이틀 작성하기

<FigmaImage id="" alt="타이틀 말줄임 처리 예시" />
...
<FigmaImage id="" alt="우측 액션 영역 사용 가이드" />
...
<FigmaImage id="" alt="Top Navigation V2와 V3 비교" />
