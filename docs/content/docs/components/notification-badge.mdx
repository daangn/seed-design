...
<FigmaImage id="" alt="Notification Badge의 Size Property - Small, Large" />
...
<FigmaImage
  id=""
  alt="Notification Badge의 위치 예시 - Top Navigation, Bottom Navigation, Tabs"
/>
...
<FigmaImage
  id=""
  alt="Notification Badge의 동작 예시 - 읽지 않은 메시지 표시, 확인 후 Badge는 사라짐"
/>
...
<FigmaImage
  id=""
  alt="Label 표시 예시 - 최대 숫자 표기, 숫자 0은 표시하지 않습니다"
/>
...
<FigmaImage id="" alt="Notification Badge 남용하지 않기 예시" />
...
<FigmaImage id="" alt="Notification Badge V2와 V3 비교 Playground" />
