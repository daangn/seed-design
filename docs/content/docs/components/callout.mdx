...
<DontImage figmaId="2:89539" body="아이콘은 Fill 타입을 사용해주세요." alt="Callout에 Line 타입 아이콘을 사용한 예시" />
...
<DontImage figmaId="2:89572" body="Actionable Callout에서는 Link Text를 사용하지 마세요." alt="Actionable Callout에서 Link Text를 사용하는 예시" />
...
<FigmaImage id="2:89609" alt="Title, Description, Link Text 사이 간격 표시 예시" />
...
<DontImage figmaId="2:89626" body="제목이 길어지지 않게 주의해주세요." alt="제목에 문장을 사용한 예시" />
...
<FigmaImage
  id="2:89706"
  alt="Callout의 Tone 사용 예시 - Critical, Positive"
/>

<FigmaImage
  id="2:89788"
  alt="Callout의 Tone 사용 예시 - Warning, Magic"
/>
...
<DontImage figmaId="2:89884" alt="Link Text를 Nudge 용도로 사용하는 예시" body="Link Text는 Nudge 용도로 사용하지 않습니다." />
...
<DontImage figmaId="2:90163" body="경고·오류 메시지에 Dismissible Callout을 사용하지 않습니다." alt="경고·오류 메시지에 Dismissible Callout을 사용하는 예시" />
