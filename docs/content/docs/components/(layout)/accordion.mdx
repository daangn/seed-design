...
<FigmaImage id="1030:18047" alt="Accordion의 Open Property - Collapsed, Expanded" />
...
<FigmaImage id="1030:18136" alt="Accordion의 Prefix Property - None, Icon, Custom" />
...
- **Single Expand**: 한 번에 하나의 패널만 열 수 있습니다. 다른 패널을 열면 기존 패널이 자동으로 닫힙니다.
  - 단계별 프로세스
  - 작은 화면 혹은 영역
- **Multi Expand**: 여러 패널을 동시에 열 수 있습니다. 각 패널의 상태가 독립적으로 관리됩니다.
  - FAQ
  - 콘텐츠가 풍부한 경우
...
<Grid>
  <DontImage
    figmaId="1030:18670"
    body="수평 스크롤은 어떤 경우에도 사용하지 않습니다."
    alt="Content Panel 내부에서 수평 스크롤이 발생한 예시"
  />
  <DontImage
    figmaId="1030:18861"
