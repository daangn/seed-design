...
<FigmaImage
  id="42:14918"
  alt="Text Input의 Has Value Property"
/>
...
<FigmaImage
  id="42:14929"
  alt="Text Input의 Clear Button Property"
/>
...
<FigmaImage
  id="42:14941"
  alt="Text Input의 Variant - Outline, Underline"
/>
...
<FigmaImage id="42:14947" alt="화면의 유일한 Text Input에 Underline Variant가 사용된 예시" />
<DontImage figmaId="42:14959" alt="화면의 유일한 Text Input에 Outline Variant가 사용된 예시" body="화면에 하나의 Input만 있는 경우 Underline Variant를 사용하세요." />
...
<FigmaImage
  id="42:14981"
  alt="Text Input의 Custom Input 예시"
/>
...
<DontImage figmaId="" alt="주민등록번호 입력을 두 개의 Text Input으로 나누어 구성한 예시" body="입력값이 하나인 경우 한 번에 입력할 수 있도록 해주세요." />
...
<FigmaImage
  id="42:15039"
  alt="Textarea의 Has Value Property"
/>
...
<FigmaImage
  id="42:15054"
  alt="Textarea의 Auto Size 옵션 - 자동 높이 조절"
/>
...
<FigmaImage
  id="42:15062"
  alt="Textarea의 Auto Size 비활성화 시 스크롤 동작"
/>
