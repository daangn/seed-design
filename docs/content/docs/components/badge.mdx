...
Neutral, Brand, Informative, Positive, Warning, Critical 다섯 가지 색상으로 구성되어 있으며, 전달하고자 하는 의미와 맥락에 맞게 사용할 수 있습니다.

### Variant

<FigmaImage id="2:76947" alt="Badge의 Variant Property - Solid, Outline, Weak" />
...
<DontImage figmaId="2:77604" alt="Badge Brand 컬러 과다 사용 예시" body="Brand 컬러는 꼭 필요한 경우에 사용해주세요." />
...
<DontImage figmaId="2:77949" alt="List Item 하나 당 3개 및 4개의 Badge를 사용한 예시" body="너무 많은 Badge를 나열하는 것은 피해주세요." />
<FigmaImage id="2:78029" alt="List Item 하나 당 1개 및 2개의 Badge를 사용한 예시" />

</Grid>

Badge는 정보 전달에 효과적이지만, 한 화면이나 요소에 너무 많은 Badge를 나열하면 오히려 시각적 혼란을 줄 수 있습니다.

중요한 정보만 골라 최소하고, 하나의 객체에는 1~2개 이하의 Badge만 사용하는 것이 권장됩니다.

### 너무 긴 라벨을 사용하지 않기

<Grid>

<DontImage figmaId="2:78057" alt="Badge 라벨에 긴 텍스트가 사용된 예시" body="너무 긴 라벨이 표시되지 않도록 주의해주세요." />
<FigmaImage id="2:78223" alt="Badge 라벨에 적당한 길이의 텍스트가 사용된 예시" />
...
<DontImage figmaId="2:78254" alt="Badge를 클릭 가능한 버튼처럼 사용한 예시" body="Badge를 클릭 가능한 요소로 사용하지 않습니다." />
...
액션이 필요한 경우엔 Chip 또는 Button 컴포넌트를 사용해주세요.
