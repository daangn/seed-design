...
<FigmaImage id="" alt="Badge의 Anatomy 이미지" />

## Props

### Size

<FigmaImage id="" alt="Badge의 Size Property - Large, Medium" />
...
<FigmaImage id="" alt="Badge의 Variant Property - Solid, Outline, Weak" />
...
<FigmaImage id="" alt="Badge의 스타일별 사용 예시 - Solid, Outline, Weak" />
...
<FigmaImage id="" alt="Badge Brand 컬러 사용 예시" />
...
<FigmaImage
  id=""
  alt="Badge 활용 예시 - 카테고리 표시, 부가 정보 표시, 상태 표시"
/>
...
<FigmaImage id="" alt="Badge 라벨 길이 예시" />
...
<FigmaImage id="" alt="Badge를 버튼으로 사용하지 않기" />
...
<FigmaImage id="" alt="Badge V2와 V3 비교 Playground" />
