...
<FigmaImage id="" alt="Bottom Navigation의 최대 너비 480 제한 예시" />
...
<FigmaImage id="" alt="Label 간결하게 작성하기 예시" />
...
<FigmaImage id="" alt="탭 아이템 개수 제한 - 5개 이하 권장" />

Bottom Navigation 탭 아이템은 5개를 넘지 않도록 해주세요. 더 많은 구분이 필요하다면 화면 상단에 Tabs를 사용하는 것을 고려해주세요.

### 탭에 Badge 표시하기

<FigmaImage id="" alt="탭에 Badge 표시하기 예시 - Small, Large 사이즈" />
...
<FigmaImage id="" alt="아이콘 스타일 - Fill 스타일 사용" />
...
<FigmaImage id="" alt="Bottom Navigation V2와 V3 비교 Playground" />
