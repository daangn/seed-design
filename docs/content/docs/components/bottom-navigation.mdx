...
<FigmaImage
  id="2:48080"
  alt="Bottom Navigation의 Anatomy 이미지 (KR)"
/>

<FigmaImage
  id="2:48091"
  alt="Bottom Navigation의 Anatomy 이미지 (EN/JP)"
/>
...
<DontImage figmaId="2:48242" body="5개 이상의 항목을 배치하지 마세요." alt="6개의 항목을 배치한 예시" />
...
<DontImage figmaId="2:48338" body="Fill 스타일과 Line 스타일을 혼용하지 마세요." alt="아이콘 스타일 - Fill 스타일과 Line 스타일을 혼용한 예시" />
