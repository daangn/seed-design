...
<FigmaImage id="" alt="Action Button의 Width Property - Fill, Hug" />
...
**High emphasis** (대비가 강한 배경색)

- Variant: Brand Solid, Neutral Solid, Critical Solid
- 화면 내 개수: 1개
- Usage: 가장 중요한 역할의 CTA에 사용

**Medium emphasis** (대비가 약한 배경색)

- Variant: Neutral Weak
- 화면 내 개수: 여러 개
- Usage: 대부분의 액션에 사용, High emphasis 버튼과 조합하여 사용

**Low emphasis** (투명한 배경색)

- Variant: Brand Outline, Neutral Outline, Ghost
- 화면 내 개수: 여러 개
- Usage: 중요도가 낮은 보조 액션을 표현할 때 사용, Brand Outline, Neutral Outline을 조합하여 사용
...
<FigmaImage id="" alt="Action Button과 Chip 비교 이미지" />
...
<FigmaImage id="" alt="Action Button V2와 V3 비교 Playground" />
