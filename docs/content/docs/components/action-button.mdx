---
title: Action Button
description: 사용자가 명확한 액션을 쉽게 수행할 수 있도록 돕는 기본 인터랙션 컴포넌트입니다.
...
<FigmaImage id="2:28463" alt="Action Button Brand Solid variant와 Neutral Solid Variant" />

<FigmaImage id="2:28596" alt="Action Button Critical Solid variant와 Neutral Weak Variant" />

<FigmaImage id="2:28657" alt="Action Button Neutral Outline variant와 Brand Outline Variant" />
...
<FigmaImage figmaId="2:28736" alt="Action Button Brand 컬러 사용 예시" />

Brand 컬러는 브랜드의 정체성과 가치를 전달하는 중요 자산으로, 로고, 대표 버튼, 핵심 메시지 등 브랜드 상징 요소에 집중 사용해야 합니다.

<DontImage figmaId="2:28889" alt="Action Button Brand 컬러 과다 사용 예시" body="무분별하게 Brand 컬러를 사용하지 않습니다." />
...
<DoImage figmaId="2:29133" alt="Neutral Weak Action Button을 나란히 배치한 예시" body="Neutral Weak 버튼을 나란히 사용할 수 있습니다." />
<DontImage figmaId="2:29220" alt="" body="버튼을 4개 이상 나란히 사용하지 않습니다." />
...
<DoImage figmaId="2:29133" alt="Action Button의 Label로 '시작하기'를 사용한 예시" body="사용자 행동을 중심으로 Label을 작성합니다." />
<DontImage figmaId="2:29220" alt="Action Button의 Label로 '다음'을 사용한 예시" body="‘무엇을 한다’는 동작을 명확하게 표현해야 합니다." />
...
<FigmaImage id="2:29305" alt="두 개의 Action Button을 좌우와 상하로 배치한 예시" />
...
<DontImage figmaId="2:29540" alt="Action Button에 불필요한 아이콘을 사용한 예시" body="아이콘을 무분별하게 사용하지 않습니다." />
<DontImage figmaId="2:29805" alt="Action Button에 라벨 앞과 뒤에 동시에 아이콘을 사용한 예시" body="라벨의 앞과 뒤에 아이콘을 동시에 표시할 수 없습니다." />
...
- **목적**: 액션 실행
- **예시**: '완료', '제출', '다음', '삭제'
- **라벨 표현**: 라벨만 봐도 액션이 예상됨
- **라벨 목적**: 어떠한 행동을 하는지 인지하는 것이 중요
- **사용 패턴**: 단일로도 사용 가능

### Chip

- **목적**: 정보 표현 + 선택 표현
- **예시**: 필터 ('서초4동 외 34'), 옵션 선택 ('0~6개월')
- **라벨 표현**: 선택하거나 활성화된 내용을 표시
- **라벨 목적**: 현재 어떤 조건/정보가 활성 상태인지 확인하는 게 중요
- **사용 패턴**: 2개 이상 그룹으로 사용 권장

## Action Button V3 변경점

### 주요 변경점

<FigmaImage id="2:30030" alt="Action Button V2와 V3 비교 Playground" />
