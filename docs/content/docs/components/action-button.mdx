...
<DoImage figmaId="2:29267" alt="Action Button의 Label로 '시작하기'를 사용한 예시" body="사용자 행동을 중심으로 Label을 작성합니다." />
<DontImage figmaId="2:29282" alt="Action Button의 Label로 '다음'을 사용한 예시" body="‘무엇을 한다’는 동작을 명확하게 표현해야 합니다." />
