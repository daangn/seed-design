...
<FigmaImage id="" alt="Radio의 Tone Property - Neutral" />
...
<FigmaImage id="" alt="Radio touch target 영역 예시" />

Radio는 Label을 포함한 영역이 Target으로 동작합니다. List처럼 Radiomark를 조합해서 사용하는 경우 전체 Row가 Target 영역이 되어야 합니다.

### 하나만 선택 가능할 때 사용하기

<FigmaImage id="" alt="Radio를 단일 선택으로 사용하는 예시" />
...
<DontImage
  ...
  alt="여러 옵션 선택이 가능한 경우 Checkbox를 사용하는 예시"
/>

### 기본 선택 제공하기

<FigmaImage id="" alt="Radio 기본 선택 제공 예시" />
...
<FigmaImage id="" alt="Radio를 가로로 나열하지 않는 예시" />
...
<FigmaImage id="" alt="옵션 개수에 따른 Radio와 Input Button 사용 예시" />
...
Input Button은 곧 배포될 예정입니다.

## Radio VS Checkbox VS Chip Group

<FigmaImage id="" alt="Radio, Checkbox, Chip Group 비교표" />
...
<FigmaImage id="" alt="Radio V2와 V3 비교 Playground" />
