...
<FigmaImage id="" alt="Checkbox의 Tone Property - Neutral" />
...
<FigmaImage id="" alt="Checkbox의 Shape Property - Square, Ghost" />
...
<FigmaImage
  id=""
  alt="Checkbox의 Touch Target 영역 - Label 포함 영역과 Row 전체 영역"
/>
...
<FigmaImage
  id=""
  alt="Checkbox Group 사용 예시 - 부모 Checkbox와 자식 Checkbox 구성"
/>
