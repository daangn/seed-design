...
<FigmaImage id="" alt="Chip의 Size Property - Large, Medium, Small" />

Chip은 Large, Medium, Small 세 가지 Size를 가집니다.

### State

<FigmaImage id="" alt="Chip의 State - Enabled, Pressed, Disabled" />

Chip은 선택 여부에 따라 각각 Enabled, Pressed, Disabled 상태를 가집니다.

### Prefix Property

<FigmaImage id="" alt="Chip의 Prefix Property - Icon, Avatar, Image" />
...
<FigmaImage id="" alt="Chip의 Suffix Property - Icon" />
...
<FigmaImage id="" alt="Chip, Chip Group, Filter Bar, Tabs 활용 예시" />
...
<FigmaImage id="" alt="Chip Group Layout - Scrollable과 Overflow 레이아웃" />

Chip Group은 한 줄에 표시하는 Scrollable Layout과 모든 Chip을 표시하는 Overflow Layout 두 가지 방법으로 표시할 수 있습니다.

### Filter Bar

<FigmaImage id="" alt="Filter Bar 사용 예시 - 필터 비활성과 필터 활성화" />
...
<FigmaImage id="" alt="Chip V2와 V3 비교 Playground" />
