...
Suffix Slot은 Label의 오른쪽 위치합니다. Suffix에는 Icon 타입을 프리셋 형태로 제공합니다.
...
<FigmaImage id="2:59529" alt="Chip Group Layout - Scrollable과 Overflow 레이아웃" />

Chip Group은 한 줄에 표시하는 Scrollable Layout과 모든 Chip을 표시하는 Overflow Layout 두 가지 방법으로 표시할 수 있습니다.

### Filter Bar

<FigmaImage id="2:59648" alt="Filter Bar 사용 예시 - 필터 비활성과 필터 활성화" />
