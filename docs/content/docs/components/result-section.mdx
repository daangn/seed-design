...
Result Section 컴포넌트 영역 내에 버튼을 제공합니다. 현재 상태를 해결하거나 보조적인 정보를 제공하는 역할을 합니다. 따라서 필요에 따라 사용할 수있습니다.
...
| **'돌아가기'** | 되돌아갈 수 없는 상황에서 '홈' 같은 안전한 목적지로 사용자를 명확히 안내합니다. |
