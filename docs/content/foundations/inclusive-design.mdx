...
whenToRead: 텍스트 명도 대비(APCA Lc)나 최소 터치 영역(44px 권장, 24px 최소)을 정하거나, 대체 텍스트·오류 메시지·애니메이션·자동 재생·폰트 크기 설정 같은 접근성 요구사항을 디자인에 반영할 때 읽는다.
coverImage: /og/foundations/inclusive-design
---
