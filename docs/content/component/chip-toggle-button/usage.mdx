...
<Iframe
  src="https://sprout-storybook.vercel.app/iframe.html?args=&id=components-chips-chiptogglebutton--basic&viewMode=story"
  height="80px"
/>
...
<HalfCard>
  <HalfCardImageCell>
    ![chipbutton options size](./images/chiptogglebutton-options-size.png)
  </HalfCardImageCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![chip filter options
    selection](./images/chiptogglebutton-options-selection.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![chip filter options
    disabled](./images/chiptogglebutton-options-disabled.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![chip filter options icon](./images/chiptogglebutton-options-icon.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<FullCard>
  <FullCardImageCell>
    ![chiptogglebutton-usage-click-touch](./images/chiptogglebutton-usage-click-touch.png)
  </FullCardImageCell>
  <FullCardDescription>
...
<HalfCard>
  <HalfCardImageCell>
    ![chiptogglebutton-usage-focus](./images/chiptogglebutton-usage-focus.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<DoDontLayout>
  <DoBox>
    <DoImage>
      ![chiptogglebutton-guideline-do](./images/chiptogglebutton-guideline-do.png)
    </DoImage>
    <DoText>
  ...
  <DontBox>
    <DontImage>
      ![chiptogglebutton-guideline-dont](./images/chiptogglebutton-guideline-dont.png)
    </DontImage>
    <DontText>
