...
<HalfCard>
  ...
  <HalfCardDescriptionCell>
    ...
    <HalfCardDescription>
      Spinner는 gray, primary, gray(on overlay) 3개의 컬러 옵션을 가질 수
...
<HalfCard>
  ...
  <HalfCardDescriptionCell>
    ...
    <HalfCardDescription>
      화면 전체 단위를 로딩하는 경우엔, Medium Size 옵션을 사용합니다. 화면의
      중앙에 노출됩니다.
    </HalfCardDescription>
  </HalfCardDescriptionCell>
</HalfCard>
...
<HalfCard>
  ...
  <HalfCardDescriptionCell>
    ...
    <HalfCardDescription>
      Bottomsheet, Dialog는 Sheet의 개념으로 접근하며, Small이 아닌 medium을
      사용합니다.
    </HalfCardDescription>
  </HalfCardDescriptionCell>
</HalfCard>
