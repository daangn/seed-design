...
8. Caret
9. Suffix
10. Description - Primitive.Description
11. Error message - Primitive.ErrorMessage
12. Character Count
13. Max Length
...
| ---------------------------------------------------- | --------- | --------------------- |
| Label, Required Indicator, Optional Indicator, Caret | Color     | $scale.color.gray-900 |
...
|          | Description    | Color         | $scale.color.gray-600         |
|          | Error Message  | Color         | $semantic.color.danger        |
|          | Charcter Count | Color         | $semantic.color.primary       |
|          | Max Length     | Color         | $scale.color.gray-600         |
