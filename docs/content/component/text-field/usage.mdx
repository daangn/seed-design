...
<DoDontLayout>
  <DoBox>
    <DoImage>![textfield guideline](./textfield-guideline-do-1.png)</DoImage>
    <DoText>
      여러 개의 Text Field가 존재하고 Indicator 표시가 필요한 경우, 더 빈도가 적은 Indicator를 표시합니다.
    </DoText>
  </DoBox>
  <DontBox>
    <DontImage>![textfield guideline](./textfield-guideline-dont-1.png)</DontImage>
    <DontText>
...
<DoDontLayout>
  <DoBox>
    <DoImage>![textfield guideline](./textfield-guideline-do-2.png)</DoImage>
    <DoText>
      Placeholder는 유저가 입력해야 하는 정보의 예시를 나타냅니다. 이는 힌트 역할을 하여 무엇을 입력해야 할지에 대한 명확한 이해를 돕습니다.
    </DoText>
  </DoBox>
  <DontBox>
    <DontImage>![textfield guideline](./textfield-guideline-dont-2.png)</DontImage>
    <DontText>
