...
<Anatomy>![extended FAB usage anatomy](./images/anatomy.png)</Anatomy>
...
<Iframe
  src="https://sprout-storybook.vercel.app/iframe.html?args=&id=components-fabs-extendedfab--basic&viewMode=story"
  height="100px"
/>
...
<HalfCard>
  <HalfCardImageCell>
    ![extended fab options size](./images/extendedfab-options-size.png)
  </HalfCardImageCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![extended fab options variant](./images/extendedfab-options-variant.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![extended fab options icon,
    label](./images/extendedfab-options-icon-label.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<FullCard>
  <FullCardImageCell>
    ![extendedfab-usage-click-touch](./images/extendedfab-usage-click-touch.png)
  </FullCardImageCell>
  <FullCardDescription>
...
<HalfCard>
  <HalfCardImageCell>
    ![extended-fab-usage-keyboard](./images/extendedfab-usage-keyboard.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
