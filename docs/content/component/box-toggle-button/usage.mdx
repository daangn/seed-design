...
<HalfCard>
  <HalfCardImageCell>
    ![box button guideline](./boxtogglebutton-guideline.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<DoDontLayout>
  ...
  <DontBox>
    <DontImage>
      ![box button guideline](./boxtogglebutton-guideline-dont-3.png)
    </DontImage>
    <DontText>Unselected 와 Selected 배리언츠를 반대로 사용하지 않습니다. </DontText>
  </DontBox>
</DoDontLayout>
