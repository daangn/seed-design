...
<HalfCard>
  <HalfCardImageCell>
    ![checkbox options label](./boxbutton-options-size.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
    <HalfCardDescriptionTitle>Size</HalfCardDescriptionTitle>
    <HalfCardDescription>
      Boxbutton은 xsmall, small, medium, large, xlarge 5개의 사이즈를 가질 수
...
<HalfCard>
  <HalfCardImageCell>
    ![checkbox options label](./boxbutton-options-variant.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
    <HalfCardDescriptionTitle>Variant</HalfCardDescriptionTitle>
    <HalfCardDescription>
      Boxbutton은 primary, primary-low, secondary, danger 4개의 스타일 옵션을
...
<HalfCard>
  <HalfCardImageCell>
    ![checkbox options label](./boxbutton-options-disabled.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
