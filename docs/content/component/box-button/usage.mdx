...
<HalfCard>
  <HalfCardImageCell>
    ![box button guideline](./boxbutton-guideline.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<DoDontLayout>
  <DoBox>
    <DoImage>![box button guideline](./boxbutton-guideline-do.png)</DoImage>
    <DoText>
...
<DoDontLayout>
  <DoBox>
    <DoImage>![box button guideline](./boxbutton-guideline-dont-7.png)</DoImage>
    <DoText>
  ...
  <DontBox>
    <DontImage>
      ![box button guideline](./boxbutton-guideline-dont-8.png)
    </DontImage>
    <DontText>
...
<DoDontLayout>
  <DoBox>
    <DoImage>![box button guideline](./boxbutton-guideline-dont-3.png)</DoImage>
...
<DoDontLayout>
  <DoBox>
    <DoImage>![box button guideline](./boxbutton-guideline-dont-5.png)</DoImage>
    <DoText>Suffix에는 Chevron Icon만 사용할 수 있습니다.</DoText>
  </DoBox>
  <DontBox>
    <DontImage>
      ![box button guideline](./boxbutton-guideline-dont-6.png)
    </DontImage>
