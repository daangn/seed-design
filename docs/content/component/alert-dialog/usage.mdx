...
| 속성                   | 값                                                             | 기본값 | 설명 |
| ---------------------- | -------------------------------------------------------------- | ------ | ---- |
| variant                | single, vertical, horizontal-secondary, horizontal-primary-low | single |      |
| title                  | string, null                                                   | null   |      |
| description            | string, null                                                   | null   |      |
| primary button label   | string, null                                                   | null   |      |
| secondary button label | string, null                                                   | null   |      |
