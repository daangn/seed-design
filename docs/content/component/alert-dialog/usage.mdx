...
<HalfCard>
  <HalfCardImageCell>
    ![alert dialog guideline](./alert-dialog-style-overflow.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
    <HalfCardDescriptionTitle>Overflow</HalfCardDescriptionTitle>
    <HalfCardDescription>
      Alert Dialog는 사용자에게 경고나 주의 사항을 강조하는 역할을 합니다.
      돌이킬 수 없는 데이터 유실이 발생하는 경우, 유저에게 경고의 메시지를
      전달합니다.
...
<DoDontLayout>
  <DoBox>
    ...
    <DoText>
      Title은 필수 작성을 권장합니다. 어떤 유형의 메시지, 알림인지 유저가 신속하게 파악할 수 있도록 합니다. 또한 스크린 리더와 같은 접근성 보조 기술에서도 Title은 중요한 역할을 합니다.
    </DoText>
  </DoBox>
  <DontBox>
    <DontImage>
...
<DoDontLayout>
  <DoBox>
    ...
    <DoText>
      Alert Dialog의 버튼 Label은 명사형으로 제공합니다. 간결한 명사형은 버튼이 수행하는 동작을 직관적으로 이해할 수 있게 해줍니다. 또한 다국어 번역 및 대응 시에도 명사형이 적합합니다.
    </DoText>
  </DoBox>
  <DontBox>
    <DontImage>
