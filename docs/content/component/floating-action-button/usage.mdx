...
<Anatomy>![FAB style anatomy](./images/anatomy.png)</Anatomy>
...
<HalfCard>
  <HalfCardImageCell>
    ![fab options size](./images/fab-options-size.png)
  </HalfCardImageCell>
...
<HalfCard>
  <HalfCardImageCell>
    ![fab options icon](./images/fab-options-icon.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
...
<FullCard>
  <FullCardImageCell>
    ![fab-usage-click-touch](./images/fab-usage-click-touch.png)
  </FullCardImageCell>
  <FullCardDescription>
...
<HalfCard>
  <HalfCardImageCell>
    ![fab-usage-keyboard](./images/fab-usage-keyboard.png)
  </HalfCardImageCell>
  <HalfCardDescriptionCell>
