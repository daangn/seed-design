...
<ComponentExample name="check-select-box-preview">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/check-select-box/preview.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="check-select-box-react-hook-form">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/check-select-box/react-hook-form.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="check-select-box-customizing-label">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/check-select-box/customizing-label.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
