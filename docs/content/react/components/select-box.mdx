...
whenToRead: React에서 테두리 박스형 선택지를 CheckSelectBox(다중)나 RadioSelectBox(단일)로 구현하며 columns 그리드, suffix 체크마크, footer 표시 조건, React Hook Form·Fieldset 연동을 확인할 때 읽는다.
---
...
<react-type-table
  path="./registry/react/ui/select-box.tsx"
