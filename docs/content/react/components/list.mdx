...
<ComponentExample name="list-preview">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/preview.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-affixes">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/affixes.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-clickable">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/clickable.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-check">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/check.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-radio">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/radio.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-disabled">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/disabled.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="list-highlighted">
  ```json doc-gen:file
  {
    "file": "./components/example/ui/list/highlighted.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
리스트 항목 전체 영역을 `label`로 만들고, `List.Prefix` 또는 `List.Suffix`에 [Checkmark](/react/components/checkbox#checkmark-활용하기) 또는 [RadioMark](/react/components/radio-group#radiomark-활용하기)를 넣는 경우 활용할 수 있는 패턴입니다.
