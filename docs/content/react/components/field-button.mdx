...
<react-type-table
  path="./registry/react/ui/field-button.tsx"
...
`Menu`와 함께 사용하면 Select와 유사한 UI를 구현할 수 있습니다. `MenuTrigger` 대신 `MenuAnchor`를 사용하고, `matchReferenceWidth`로 메뉴 너비를 맞춥니다.
...
<Card title="Menu" href="/react/components/menu" variant="example">

버튼 클릭 시 관련된 작업 항목을 보여주는 플로팅 드롭다운 메뉴 컴포넌트입니다.
...
<ComponentExample name="react/field-button/size">
  ```json doc-gen:file
  {
    "file": "examples/react/field-button/size.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
