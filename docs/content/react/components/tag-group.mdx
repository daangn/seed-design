...
whenToRead: React에서 TagGroupRoot·TagGroupItem으로 태그를 나열하며 size·weight·tone, 항목별 덮어쓰기, separator 변경, truncate 한 줄 말줄임과 flexShrink 우선순위를 구현할 때 읽는다.
---
...
<react-type-table
  path="./registry/react/ui/tag-group.tsx"
