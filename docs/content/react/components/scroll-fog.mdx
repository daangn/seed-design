...
whenToRead: React에서 스크롤 영역 가장자리에 추가 콘텐츠 힌트를 ScrollFog로 넣으며 placement 방향, size·sizes, 필요한 최소 padding, hideScrollBar를 확인할 때 읽는다.
---
...
<react-type-table
  path="../packages/react/src/components/ScrollFog/ScrollFog.tsx"
  name="ScrollFogProps"
/>
