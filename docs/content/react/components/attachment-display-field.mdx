...
whenToRead: React에서 외부 미디어 피커가 준 URL 목록을 AttachmentDisplayField로 보여주며 onTriggerClick·addEntries로 추가, updateEntryStatus로 업로드 상태, 드래그 순서 변경을 구현할 때 읽는다.
---
...
<react-type-table
  path="./registry/react/ui/attachment-display-field.tsx"
