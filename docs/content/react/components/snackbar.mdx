...
whenToRead: React에서 SnackbarProvider와 useSnackbarAdapter로 Snackbar를 띄우며 positive·critical variant, pauseOnInteraction, queued strategy, SnackbarAvoidOverlap 겹침 방지를 구현할 때 읽는다.
---
...
<react-type-table path="./registry/react/ui/snackbar.tsx" name="SnackbarProps" />

### `SnackbarAdapter.create` Parameters (`CreateSnackbarOptions`)

<react-type-table
  path="./registry/react/ui/snackbar.tsx"
  name="CreateSnackbarOptions"
/>

### `SnackbarProvider`

<react-type-table path="./registry/react/ui/snackbar.tsx" name="SnackbarProviderProps" />
