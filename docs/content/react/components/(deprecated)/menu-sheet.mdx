...
whenToRead: deprecated된 React MenuSheet의 기존 코드를 유지보수하며 title·description, labelAlign, onOpenChange reason을 확인할 때만 읽는다.
deprecated: true
---
...
<react-type-table
  path="./registry/react/ui/menu-sheet.tsx"
