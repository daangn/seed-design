...
whenToRead: React에서 BottomSheet를 구현하며 snapPoints, maxHeight, showHandle·dismissible, Scroll Fog 조합, onOpenChange reason을 확인할 때 읽는다.
---
...
<react-type-table
  path="./registry/react/ui/bottom-sheet.tsx"
