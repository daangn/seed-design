...
whenToRead: React에서 하단 시트형 메뉴를 SwipeableMenuSheet로 구현하며 스와이프로 닫기, title·description, showCloseButton, labelAlign, onOpenChange reason을 확인할 때 읽는다.
---
...
<ComponentExample name="react/swipeable-menu-sheet/with-close-button">
  ```json doc-gen:file
  {
    "file": "examples/react/swipeable-menu-sheet/with-close-button.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
