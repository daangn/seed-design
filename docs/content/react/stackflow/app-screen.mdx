...
<StackflowExample path="/legacy-app-screen?contentMode=bare">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreen.tsx",
    "codeblock": {
      "meta": "title='ActivityLegacyAppScreen.tsx'"
    }
  }
  ```
</StackflowExample>
...
<StackflowExample path="/legacy-app-screen?tone=transparent&layerOffsetTop=none">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreen.tsx",
    "codeblock": {
...
<StackflowExample path="/legacy-app-screen-intersection-observer">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreenIntersectionObserver.tsx",
    "codeblock": true
  }
  ```
</StackflowExample>
...
<StackflowExample path="/legacy-app-screen-app-bar-customization">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreenAppBarCustomization.tsx",
    "codeblock": true
  }
  ```
</StackflowExample>
...
`AppBarSlot`은 하위 요소에 `data-part` 속성을 주입하여 트랜지션 엔진이 해당 요소를 IconButton과 동일한 그룹으로 인식하게 하며, 추가 마크업은 생성하지 않습니다.

<StackflowExample path="/legacy-app-screen?mainSlot=slot">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreen.tsx",
    "codeblock": {
...
<StackflowExample path="/legacy-app-screen">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityLegacyAppScreen.tsx",
    "codeblock": {
