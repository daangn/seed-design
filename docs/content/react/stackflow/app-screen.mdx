...
<StackflowExample path="/app-screen?contentMode=bare">
  ```json doc-gen:file
  {
...
<StackflowExample path="/app-screen?tone=transparent&layerOffsetTop=none">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityAppScreen.tsx",
    "codeblock": {
...
<StackflowExample path="/app-screen?mainSlot=slot">
  ```json doc-gen:file
  {
    "file": "../examples/stackflow-spa/src/activities/ActivityAppScreen.tsx",
    "codeblock": {
