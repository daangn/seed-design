...
description: Seed Design V3의 개선사항을 안내합니다.
---
...
[Icon Usage](/react/components/concepts/composition) 페이지에서 자세히 설명합니다.
...
- [V3 컴포넌트 보러가기 (MultilineTextField)](/react/components/multiline-text-field)
...
- [V3 컴포넌트 보러가기 (CheckSelectBox)](/react/components/check-select-box)
...
- [V3 컴포넌트 보러가기 (RadioSelectBox)](/react/components/radio-select-box)
...
- [V3 컴포넌트 보러가기 (Tabs)](/react/components/tabs)
...
- V3 Tabs와 동일한 인터페이스
- [V3 컴포넌트 보러가기 (ChipTabs)](/react/components/chip-tabs)
...
- [V3 컴포넌트 보러가기 (Box)](/react/components/layout/box)
- [V3 컴포넌트 보러가기 (Flex)](/react/components/layout/flex)
- [V3 컴포넌트 보러가기 (VStack)](/react/components/layout/v-stack)
- [V3 컴포넌트 보러가기 (HStack)](/react/components/layout/h-stack)
