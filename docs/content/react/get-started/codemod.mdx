...
### replace-custom-component-color-prop

```package-install
npx @seed-design/codemod replace-custom-component-color-prop <target_path>
```
...
### replace-custom-component-typography-prop

```package-install
npx @seed-design/codemod replace-custom-component-typography-prop <target_path>
```
