...
`@seed-design/css/vars/component/typography`를 제외한 `@seed-design/css/vars/component/*` 경로는 SemVer 보장 대상이 아니에요. rootage component spec이 바뀌면 minor·patch에서도 이름이나 구조가 바뀔 수 있습니다.
...
https://seed-design.io/react/develop-with-seed 가이드를 기준으로 점검해줘.
