...
- [`@ride-developer/icon`](https://www.npmjs.com/package/@ride-developer/icon) (deprecated)
...
- 다음 패키지를 사용하는 경우
  - [`@ride-developer/vue2-icon`](https://www.npmjs.com/package/@ride-developer/vue2-icon) → [`@daangn/vue2-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue2-monochrome-icon)으로 대체돼요.
  - [`@ride-developer/vue3-icon`](https://www.npmjs.com/package/@ride-developer/vue3-icon) → [`@daangn/vue3-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue3-monochrome-icon)으로 대체돼요.
...
```package-install
npm uninstall @ride-developer/icon @seed-design/react-icon @karrotmarket/karrot-ui-icon
```
...
```package-install
npm uninstall @ride-developer/icon @seed-design/react-icon @karrotmarket/karrot-ui-icon @ride-developer/vue2-icon @ride-developer/vue3-icon
```
