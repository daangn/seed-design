...
```package-install
npx @ride-developer/codemod@latest replace-custom-seed-design-typography <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-tailwind-typography <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-imported-typography-variable <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-seed-design-vars <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-stitches-styled-typography <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-stitches-theme-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-css-seed-design-color-variable <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-react-icon <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-seed-design-token-vars <target_path>
```
...
@ride-developer/css v0.2.0에서 업데이트된 시맨틱 stroke 컬러 토큰을 자동으로 마이그레이션합니다.
...
```package-install
npx @ride-developer/codemod@latest replace-semantic-stroke-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-seed-design-text-component <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-seed-design-token-typography-classname <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-stitches-styled-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-text-component-color-prop <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-alpha-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-seed-design-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-custom-color-to-seed-design-vars-color <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-css-seed-design-typography-variable <target_path>
```
...
```package-install
npx @ride-developer/codemod@latest replace-tailwind-color <target_path>
```
