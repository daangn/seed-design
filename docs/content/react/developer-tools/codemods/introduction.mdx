...
whenToRead: "@seed-design/codemod를 실행하면서 transform·대상 경로 지정 형식, --list·--log·--parser·--extensions 옵션, Node.js 20.19 이상 요구사항을 확인할 때 읽는다."
---
...
스크립트 실행을 위해서는 Node.js 20.19.0 이상의 버전이 필요해요. 버전 요구사항을 만족시키지 않으면 안내 문구가 표시돼요.
