...
3.0부터 컴포넌트 vars는 `@seed-design/css/vars/component/typography`만 공개해요.

스타일이 필요하면 SEED 컴포넌트를 그대로 쓰고, 값이 직접 필요하면 [디자인 토큰](/foundations/color)(`@seed-design/css/vars`)을 쓰세요. 2.x에서 다른 컴포넌트 vars를 import하고 있었다면 SEED 3.0으로 올리기 전에 디자인 토큰으로 옮겨야 해요.
