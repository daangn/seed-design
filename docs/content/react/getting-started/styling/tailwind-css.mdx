...
눌렸을 때의 축소 배율은 요소의 실제 크기에서 계산되므로 토큰이 아니라 CSS custom property로 발행됩니다. 커스텀 컴포넌트에 적용하는 방법과 프로젝트에 유틸리티로 등록하는 방법은 아래 문서에 있습니다.

<Card
  href="/react/components/concepts/pressed-scale"
  title="Pressed Scale"
>
