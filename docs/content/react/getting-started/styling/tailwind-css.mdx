...
```package-install
@ride-developer/css @ride-developer/tailwind4-theme
```
...
@import "@ride-developer/css/base.layered.css";
@import "tailwindcss";
@import "@ride-developer/tailwind4-theme";
```
...
```package-install
@ride-developer/css @ride-developer/tailwind3-plugin
```
...
import seedPlugin from "@ride-developer/tailwind3-plugin"; // [!code highlight]
