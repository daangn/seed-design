---
title: Commands
description: "@seed-design/cli 패키지를 사용하여 seed-design을 더 쉽게 사용할 수 있어요."
---
...
<Card icon={<File />} title="Configuration" href="/react/getting-started/cli/configuration#옵션">

`seed-design.json` 파일에 대해 알아봐요.
...
Options:
  ...
  --include-deprecated     Include deprecated components when used with `--all` (default: false)
