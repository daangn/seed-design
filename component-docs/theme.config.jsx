  ...
  logo: () => (
    <div style={{ display: "flex" }}>
      <svg width="60" height="25" viewBox="0 0 191 103" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M3.99994 51.5C3.99994 78.8153 41.7528 99 95.5721 99C149.391 99 187.144 78.8153 187.144 51.5C187.144 24.1847 149.391 4 95.5721 4C41.7528 4 3.99994 24.1847 3.99994 51.5Z" stroke="black" stroke-width="6.50685"/>
      </svg>
