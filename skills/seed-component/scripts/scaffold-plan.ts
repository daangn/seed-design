...
import { mapSeedComponent, type ComponentMapResult, type ComponentPlatform } from "./component-map";
...
async function runCli(args: string[]): Promise<void> {
  try {
    ...
    if (!component) {
      throw new Error(
        "사용법: bun skills/seed-component/scripts/scaffold-plan.ts <component> --platform <platform> --surface <surface>",
      );
    }
