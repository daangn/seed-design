...
function lynxRuntimeReviewStep(paths: string[]): VerificationStep | undefined {
  ...
  return {
    ...
    evidence,
    source: "skills/seed-component/references/lynx-docs.md",
  };
}
...
function reactVisualStep(paths: string[]): VerificationStep | undefined {
  ...
  return {
    ...
    evidence,
    source: "skills/seed-component/references/verification-checklist.md",
  };
}
...
function changesetStep(
  ...
  return {
    ...
    source: "skills/seed-change/references/changeset.md",
  };
}
