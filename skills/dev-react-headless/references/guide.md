...
4. Multi-part 컴포넌트는 namespace 패턴을 사용하고 상세 패턴은 `references/patterns.md`를 참고합니다.
...
각 패턴의 상세 내용은 `references/` 폴더 참조:

- `references/patterns.md` - Hook, Namespace, Context 패턴
