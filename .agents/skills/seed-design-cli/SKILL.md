...
description: SEED Design CLI의 init/add/add-all 사용법, seed-design.json 설정, --baseUrl 호환 스니펫 운영, 파일 충돌 처리 전략을 안내합니다.
---
...
3. 버전 호환이 필요하면 `--baseUrl`로 맞는 레지스트리를 지정합니다.
4. 파일 충돌 시 덮어쓰기/백업/건너뛰기 전략을 선택합니다.
