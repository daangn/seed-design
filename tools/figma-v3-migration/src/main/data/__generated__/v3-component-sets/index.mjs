export { metadata as templateBannerDetach후사용 } from "./template-banner-detach-후-사용.mjs";
...
export { metadata as osNotificationFigmaOnly } from "./os-notification-figma-only.mjs";
