...
- 8e1e56a: `TagGroup` 아이콘을 텍스트의 cap-height 중심에 맞추고, 인라인 높이가 늘어나지 않도록 수정합니다.

## 1.2.17

### Patch Changes

- 377c569: Android WebView에서 시스템 폰트 스케일링이 `t*Static` 폰트 크기·행간 토큰에도 적용되던 문제를 수정합니다. 이제 static 토큰 및 텍스트 스타일은 의도된 px 크기로 렌더링됩니다.
