...
export declare type FieldSlotName = "root" | "header" | "indicatorText" | "indicatorIcon" | "footer" | "description" | "errorMessage" | "characterCountArea" | "characterCount" | "maxCharacterCount";
