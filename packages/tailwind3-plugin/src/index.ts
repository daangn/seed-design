...
export default plugin(
  ({ theme, addComponents, matchUtilities }) => {  
    ...
    const gradientStopsForArbitrary = {
      ...
      "glow-magic": "#ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%",
  ...
  "gradient-stops-glow-magic": "#ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%",
  ...
  "glow-magic-to-t": "linear-gradient(to top, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-tr": "linear-gradient(to top right, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-r": "linear-gradient(to right, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-br": "linear-gradient(to bottom right, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-b": "linear-gradient(to bottom, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-bl": "linear-gradient(to bottom left, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-l": "linear-gradient(to left, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
  "glow-magic-to-tl": "linear-gradient(to top left, #ffffff 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
