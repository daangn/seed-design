    ...
    theme: {
      extend: {
        colors: {
          ...
          "stroke-warning": "var(--seed-color-stroke-warning)",
          ...
          "gradient-stops-shimmer-neutral":
            "#ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%",
          "gradient-stops-shimmer-magic":
            "#fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%",
        ...
        backgroundImage: {
          ...
          "fade-layer-floating-to-tr":
            "linear-gradient(to top right, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-r": "linear-gradient(to right, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-br":
            "linear-gradient(to bottom right, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-b":
            "linear-gradient(to bottom, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-bl":
            "linear-gradient(to bottom left, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-l": "linear-gradient(to left, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-floating-to-tl":
            "linear-gradient(to top left, #ffffff00 0.00%, #000000 100.00%)",
          "fade-layer-default-to-t": "linear-gradient(to top, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-tr":
            "linear-gradient(to top right, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-r": "linear-gradient(to right, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-br":
            "linear-gradient(to bottom right, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-b": "linear-gradient(to bottom, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-bl":
            "linear-gradient(to bottom left, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-l": "linear-gradient(to left, #000000 0.00%, #ffffff00 100.00%)",
          "fade-layer-default-to-tl":
            "linear-gradient(to top left, #000000 0.00%, #ffffff00 100.00%)",
          "glow-magic-to-t":
            "linear-gradient(to top, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-tr":
            "linear-gradient(to top right, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-r":
            "linear-gradient(to right, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-br":
            "linear-gradient(to bottom right, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-b":
            "linear-gradient(to bottom, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-bl":
            "linear-gradient(to bottom left, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-l":
            "linear-gradient(to left, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-to-tl":
            "linear-gradient(to top left, #fef6f7 0.00%, #fef0e7 80.00%, #f9f7f5 100.00%)",
          "glow-magic-pressed-to-t":
            "linear-gradient(to top, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-tr":
            "linear-gradient(to top right, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-r":
            "linear-gradient(to right, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-br":
            "linear-gradient(to bottom right, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-b":
            "linear-gradient(to bottom, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-bl":
            "linear-gradient(to bottom left, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-l":
            "linear-gradient(to left, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "glow-magic-pressed-to-tl":
            "linear-gradient(to top left, #fbf0f2 0.00%, #ffe8db 80.00%, #f5f2ef 100.00%)",
          "shimmer-neutral-to-t":
            "linear-gradient(to top, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-tr":
            "linear-gradient(to top right, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-r":
            "linear-gradient(to right, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-br":
            "linear-gradient(to bottom right, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-b":
            "linear-gradient(to bottom, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-bl":
            "linear-gradient(to bottom left, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-l":
            "linear-gradient(to left, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-neutral-to-tl":
            "linear-gradient(to top left, #ffffff00 0.00%, #ffffff66 46.00%, #ffffff66 54.00%, #ffffff00 100.00%)",
          "shimmer-magic-to-t":
            "linear-gradient(to top, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-tr":
            "linear-gradient(to top right, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-r":
            "linear-gradient(to right, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-br":
            "linear-gradient(to bottom right, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-b":
            "linear-gradient(to bottom, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-bl":
            "linear-gradient(to bottom left, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-l":
            "linear-gradient(to left, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "shimmer-magic-to-tl":
            "linear-gradient(to top left, #fff9f500 0.00%, #fff9f58a 46.00%, #fff9f58a 54.00%, #fff9f500 100.00%)",
          "highlight-magic-pressed-to-t":
            "linear-gradient(to top, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-tr":
            "linear-gradient(to top right, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-r":
            "linear-gradient(to right, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-br":
            "linear-gradient(to bottom right, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-b":
            "linear-gradient(to bottom, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-bl":
            "linear-gradient(to bottom left, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-l":
            "linear-gradient(to left, #e14f00 20.00%, #ae58bf 100.00%)",
          "highlight-magic-pressed-to-tl":
            "linear-gradient(to top left, #e14f00 20.00%, #ae58bf 100.00%)",
          ...
          "highlight-magic-to-br":
            "linear-gradient(to bottom right, #ff6600 20.00%, #d25aca 100.00%)",
          "highlight-magic-to-b": "linear-gradient(to bottom, #ff6600 20.00%, #d25aca 100.00%)",
          "highlight-magic-to-bl":
            "linear-gradient(to bottom left, #ff6600 20.00%, #d25aca 100.00%)",
