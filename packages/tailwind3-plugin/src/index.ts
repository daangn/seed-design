      ...
      extend: {
        colors: {
          ...
          "dimension-spacing-x-between-chips":
            "var(--seed-color-dimension-spacing-x-between-chips)",
          "dimension-spacing-x-global-gutter":
            "var(--seed-color-dimension-spacing-x-global-gutter)",
          "dimension-spacing-y-component-default":
            "var(--seed-color-dimension-spacing-y-component-default)",
          "dimension-spacing-y-nav-to-title": "var(--seed-color-dimension-spacing-y-nav-to-title)",
          "dimension-spacing-y-screen-bottom":
            "var(--seed-color-dimension-spacing-y-screen-bottom)",
