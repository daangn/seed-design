...
### 1. lynx-ui-common dependency 추가

`packages/lynx-react/package.json`에 추가한다.

```bash
bun add lynx-ui-common
```
...
lynx-ui-common에 없으므로 직접 구현. lynx-ui-switch의 인라인 패턴을 참고.
...
**참고 파일:**
- lynx-ui-switch: `/Documents/GitHub/lynx-ui/packages/lynx-ui-switch/src/switch.tsx` (인라인 구현)
- Radix: `@radix-ui/react-use-controllable-state` (웹 버전 참고용)
...
**참고 파일:**
- lynx-ui-switch: `/Documents/GitHub/lynx-ui/packages/lynx-ui-switch/src/use-press-tap.ts`
- lynx-ui-switch: `/Documents/GitHub/lynx-ui/packages/lynx-ui-switch/src/use-effect-event.ts`
...
- [ ] `package.json`에 `lynx-ui-common` 추가
