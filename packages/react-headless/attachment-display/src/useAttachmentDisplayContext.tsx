...
import type { UseAttachmentDisplayItemReturn } from "./useAttachmentDisplayItem";
...
export type AttachmentDisplayItemContext = DisplayItemEntry & UseAttachmentDisplayItemReturn;
