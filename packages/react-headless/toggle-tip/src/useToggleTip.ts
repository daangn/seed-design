...
export interface UseToggleTipProps extends UsePositionedFloatingProps {
  /**
   * Whether to close the toggle-tip when clicking outside of it.
   * @default true
   */
  closeOnInteractOutside?: boolean;
}

export type UseToggleTipReturn = ReturnType<typeof useToggleTip>;

export function useToggleTip({ closeOnInteractOutside, ...props }: UseToggleTipProps = {}) {
  const {
    open,
    onOpenChange,
    refs,
