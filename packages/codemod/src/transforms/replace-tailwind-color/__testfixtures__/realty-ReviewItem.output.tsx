...
const review = tv({
  base: `text-gray-500 rounded-5 [&_h3]:title3Bold [&_p]:bodyL2Regular w-[85vw] max-w-[300px] items-start px-4 py-6`,
  variants: {
    mode: {
      dark: "bg-gray-200",
      light: "bg-gray-100",
...
const mainReview = tv({
  base: [
    review(),
    "bg-gray-00 text-gray-1000 [&_h3]:text-gray-1000 [&_p]:text-gray-700 shadow-[0px_0px_4px_rgba(0,0,0,0.04),0px_0px_20px_rgba(0,0,0,0.1)]",
  ],
});
