file: components/concepts/composition.mdx
...
### React 컴포넌트와 조합하기 \[#react-컴포넌트와-조합하기]
...
#### 1. 컴포넌트는 props를 전개해야 합니다 \[#1-컴포넌트는-props를-전개해야-합니다]
...
#### 2. 컴포넌트는 ref를 전달해야 합니다 \[#2-컴포넌트는-ref를-전달해야-합니다]
