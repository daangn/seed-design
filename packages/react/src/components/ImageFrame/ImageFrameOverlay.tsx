...
const GRADIENT_ID = "seed-heart-gradient";

const UnselectedHeartIcon = () => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <path d={HeartOutlineFillPath} fill="black" fillOpacity="0.063" />
...
const SelectedHeartIcon = () => (
  <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <path d={HeartFillPath} fill={`url(#${GRADIENT_ID})`} />
    <defs>
      <linearGradient
        id={GRADIENT_ID}
        x1="7"
