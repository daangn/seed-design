...
:root {
  ...
  --seed-font-size-t1-static: calc(11px / var(--seed-user-font-scale, 1));
  --seed-font-size-t2-static: calc(12px / var(--seed-user-font-scale, 1));
  --seed-font-size-t3-static: calc(13px / var(--seed-user-font-scale, 1));
  --seed-font-size-t4-static: calc(14px / var(--seed-user-font-scale, 1));
  --seed-font-size-t5-static: calc(16px / var(--seed-user-font-scale, 1));
  --seed-font-size-t6-static: calc(18px / var(--seed-user-font-scale, 1));
  --seed-font-size-t7-static: calc(20px / var(--seed-user-font-scale, 1));
  --seed-font-size-t8-static: calc(22px / var(--seed-user-font-scale, 1));
  --seed-font-size-t9-static: calc(24px / var(--seed-user-font-scale, 1));
  --seed-font-size-t10-static: calc(26px / var(--seed-user-font-scale, 1));
  --seed-font-size-t11-static: calc(28px / var(--seed-user-font-scale, 1));
  --seed-font-size-t12-static: calc(32px / var(--seed-user-font-scale, 1));
  --seed-font-size-t13-static: calc(40px / var(--seed-user-font-scale, 1));
  --seed-font-size-t14-static: calc(48px / var(--seed-user-font-scale, 1));
  ...
  --seed-line-height-t1-static: calc(15px / var(--seed-user-font-scale, 1));
  --seed-line-height-t2-static: calc(16px / var(--seed-user-font-scale, 1));
  --seed-line-height-t3-static: calc(18px / var(--seed-user-font-scale, 1));
  --seed-line-height-t4-static: calc(19px / var(--seed-user-font-scale, 1));
  --seed-line-height-t5-static: calc(22px / var(--seed-user-font-scale, 1));
  --seed-line-height-t6-static: calc(24px / var(--seed-user-font-scale, 1));
  --seed-line-height-t7-static: calc(27px / var(--seed-user-font-scale, 1));
  --seed-line-height-t8-static: calc(30px / var(--seed-user-font-scale, 1));
  --seed-line-height-t9-static: calc(32px / var(--seed-user-font-scale, 1));
  --seed-line-height-t10-static: calc(35px / var(--seed-user-font-scale, 1));
  --seed-line-height-t11-static: calc(38px / var(--seed-user-font-scale, 1));
  --seed-line-height-t12-static: calc(42px / var(--seed-user-font-scale, 1));
  --seed-line-height-t13-static: calc(52px / var(--seed-user-font-scale, 1));
  --seed-line-height-t14-static: calc(60px / var(--seed-user-font-scale, 1));
...
:root [data-seed-color-mode="light-only"] {
  ...
  --seed-color-palette-static-black: calc(#000000 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-100: calc(#00000007 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-200: calc(#0000000c / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-300: calc(#00000010 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-400: calc(#00000021 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-500: calc(#0000002c / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-600: calc(#0000004c / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-700: calc(#00000074 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-800: calc(#000000a2 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-900: calc(#000000d0 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-black-alpha-1000: calc(#000000e3 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white: calc(#ffffff / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-50: calc(#ffffff0d / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-100: calc(#ffffff17 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-200: calc(#ffffff20 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-300: calc(#ffffff2e / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-400: calc(#ffffff3d / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-500: calc(#ffffff60 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-600: calc(#ffffff8b / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-700: calc(#ffffffb3 / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-800: calc(#ffffffde / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-900: calc(#ffffffea / var(--seed-user-font-scale, 1));
  --seed-color-palette-static-white-alpha-1000: calc(#fffffff4 / var(--seed-user-font-scale, 1));
