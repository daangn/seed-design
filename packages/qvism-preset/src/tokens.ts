...
:root {
  ...
  --seed-font-size-t1: clamp(8.8px, calc(0.6875rem * var(--seed-font-size-multiplier, 1)), 13.98px);
  --seed-font-size-t2: clamp(9.6px, calc(0.75rem * var(--seed-font-size-multiplier, 1)), 15.25px);
  --seed-font-size-t3: clamp(10.4px, calc(0.8125rem * var(--seed-font-size-multiplier, 1)), 16.52px);
  --seed-font-size-t4: clamp(11.2px, calc(0.875rem * var(--seed-font-size-multiplier, 1)), 17.79px);
  --seed-font-size-t5: clamp(12.8px, calc(1rem * var(--seed-font-size-multiplier, 1)), 20.33px);
  --seed-font-size-t6: clamp(14.4px, calc(1.125rem * var(--seed-font-size-multiplier, 1)), 22.87px);
  --seed-font-size-t7: clamp(16px, calc(1.25rem * var(--seed-font-size-multiplier, 1)), 25.41px);
  --seed-font-size-t8: clamp(17.6px, calc(1.375rem * var(--seed-font-size-multiplier, 1)), 27.95px);
  --seed-font-size-t9: clamp(19.2px, calc(1.5rem * var(--seed-font-size-multiplier, 1)), 30.49px);
  --seed-font-size-t10: clamp(20.8px, calc(1.625rem * var(--seed-font-size-multiplier, 1)), 33.04px);
  ...
  --seed-line-height-t1: clamp(12px, calc(0.9375rem * var(--seed-font-size-multiplier, 1)), 19.06px);
  --seed-line-height-t2: clamp(12.8px, calc(1rem * var(--seed-font-size-multiplier, 1)), 20.33px);
  --seed-line-height-t3: clamp(14.4px, calc(1.125rem * var(--seed-font-size-multiplier, 1)), 22.87px);
  --seed-line-height-t4: clamp(15.2px, calc(1.1875rem * var(--seed-font-size-multiplier, 1)), 24.14px);
  --seed-line-height-t5: clamp(17.6px, calc(1.375rem * var(--seed-font-size-multiplier, 1)), 27.95px);
  --seed-line-height-t6: clamp(19.2px, calc(1.5rem * var(--seed-font-size-multiplier, 1)), 30.49px);
  --seed-line-height-t7: clamp(21.6px, calc(1.6875rem * var(--seed-font-size-multiplier, 1)), 34.31px);
  --seed-line-height-t8: clamp(24px, calc(1.875rem * var(--seed-font-size-multiplier, 1)), 38.12px);
  --seed-line-height-t9: clamp(25.6px, calc(2rem * var(--seed-font-size-multiplier, 1)), 40.66px);
  --seed-line-height-t10: clamp(28px, calc(2.1875rem * var(--seed-font-size-multiplier, 1)), 44.47px);
