...
:root {
  ...
  --seed-font-size-t1: clamp(calc(0.6875rem * var(--seed-font-size-multiplier)), calc(0.6875rem * var(--seed-font-size-multiplier)), 13.98px);
  --seed-font-size-t2: clamp(calc(0.75rem * var(--seed-font-size-multiplier)), calc(0.75rem * var(--seed-font-size-multiplier)), 15.25px);
  --seed-font-size-t3: clamp(calc(0.8125rem * var(--seed-font-size-multiplier)), calc(0.8125rem * var(--seed-font-size-multiplier)), 16.52px);
  --seed-font-size-t4: clamp(calc(0.875rem * var(--seed-font-size-multiplier)), calc(0.875rem * var(--seed-font-size-multiplier)), 17.79px);
  --seed-font-size-t5: clamp(calc(1rem * var(--seed-font-size-multiplier)), calc(1rem * var(--seed-font-size-multiplier)), 20.33px);
  --seed-font-size-t6: clamp(calc(1.125rem * var(--seed-font-size-multiplier)), calc(1.125rem * var(--seed-font-size-multiplier)), 22.87px);
  --seed-font-size-t7: clamp(calc(1.25rem * var(--seed-font-size-multiplier)), calc(1.25rem * var(--seed-font-size-multiplier)), 25.41px);
  --seed-font-size-t8: clamp(calc(1.375rem * var(--seed-font-size-multiplier)), calc(1.375rem * var(--seed-font-size-multiplier)), 27.95px);
  --seed-font-size-t9: clamp(calc(1.5rem * var(--seed-font-size-multiplier)), calc(1.5rem * var(--seed-font-size-multiplier)), 30.49px);
  --seed-font-size-t10: clamp(calc(1.625rem * var(--seed-font-size-multiplier)), calc(1.625rem * var(--seed-font-size-multiplier)), 33.04px);
  ...
  --seed-line-height-t1: clamp(calc(0.9375rem * var(--seed-font-size-multiplier)), calc(0.9375rem * var(--seed-font-size-multiplier)), 19.06px);
  --seed-line-height-t2: clamp(calc(1rem * var(--seed-font-size-multiplier)), calc(1rem * var(--seed-font-size-multiplier)), 20.33px);
  --seed-line-height-t3: clamp(calc(1.125rem * var(--seed-font-size-multiplier)), calc(1.125rem * var(--seed-font-size-multiplier)), 22.87px);
  --seed-line-height-t4: clamp(calc(1.1875rem * var(--seed-font-size-multiplier)), calc(1.1875rem * var(--seed-font-size-multiplier)), 24.14px);
  --seed-line-height-t5: clamp(calc(1.375rem * var(--seed-font-size-multiplier)), calc(1.375rem * var(--seed-font-size-multiplier)), 27.95px);
  --seed-line-height-t6: clamp(calc(1.5rem * var(--seed-font-size-multiplier)), calc(1.5rem * var(--seed-font-size-multiplier)), 30.49px);
  --seed-line-height-t7: clamp(calc(1.6875rem * var(--seed-font-size-multiplier)), calc(1.6875rem * var(--seed-font-size-multiplier)), 34.31px);
  --seed-line-height-t8: clamp(calc(1.875rem * var(--seed-font-size-multiplier)), calc(1.875rem * var(--seed-font-size-multiplier)), 38.12px);
  --seed-line-height-t9: clamp(calc(2rem * var(--seed-font-size-multiplier)), calc(2rem * var(--seed-font-size-multiplier)), 40.66px);
  --seed-line-height-t10: clamp(calc(2.1875rem * var(--seed-font-size-multiplier)), calc(2.1875rem * var(--seed-font-size-multiplier)), 44.47px);
