...
:root {
  ...
  --seed-font-size-t1-static: calc(11px / var(--seed-static-scale, 1));
  --seed-font-size-t2-static: calc(12px / var(--seed-static-scale, 1));
  --seed-font-size-t3-static: calc(13px / var(--seed-static-scale, 1));
  --seed-font-size-t4-static: calc(14px / var(--seed-static-scale, 1));
  --seed-font-size-t5-static: calc(16px / var(--seed-static-scale, 1));
  --seed-font-size-t6-static: calc(18px / var(--seed-static-scale, 1));
  --seed-font-size-t7-static: calc(20px / var(--seed-static-scale, 1));
  --seed-font-size-t8-static: calc(22px / var(--seed-static-scale, 1));
  --seed-font-size-t9-static: calc(24px / var(--seed-static-scale, 1));
  --seed-font-size-t10-static: calc(26px / var(--seed-static-scale, 1));
  --seed-font-size-t11-static: calc(28px / var(--seed-static-scale, 1));
  --seed-font-size-t12-static: calc(32px / var(--seed-static-scale, 1));
  --seed-font-size-t13-static: calc(40px / var(--seed-static-scale, 1));
  --seed-font-size-t14-static: calc(48px / var(--seed-static-scale, 1));
  ...
  --seed-line-height-t1-static: calc(15px / var(--seed-static-scale, 1));
  --seed-line-height-t2-static: calc(16px / var(--seed-static-scale, 1));
  --seed-line-height-t3-static: calc(18px / var(--seed-static-scale, 1));
  --seed-line-height-t4-static: calc(19px / var(--seed-static-scale, 1));
  --seed-line-height-t5-static: calc(22px / var(--seed-static-scale, 1));
  --seed-line-height-t6-static: calc(24px / var(--seed-static-scale, 1));
  --seed-line-height-t7-static: calc(27px / var(--seed-static-scale, 1));
  --seed-line-height-t8-static: calc(30px / var(--seed-static-scale, 1));
  --seed-line-height-t9-static: calc(32px / var(--seed-static-scale, 1));
  --seed-line-height-t10-static: calc(35px / var(--seed-static-scale, 1));
  --seed-line-height-t11-static: calc(38px / var(--seed-static-scale, 1));
  --seed-line-height-t12-static: calc(42px / var(--seed-static-scale, 1));
  --seed-line-height-t13-static: calc(52px / var(--seed-static-scale, 1));
  --seed-line-height-t14-static: calc(60px / var(--seed-static-scale, 1));
