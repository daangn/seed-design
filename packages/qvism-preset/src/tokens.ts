...
:root [data-seed-color-mode="light-only"] {
  ...
  --seed-gradient-neutral-shimmer: #ffffff00 0%, #ffffff66 46%, #ffffff66 54%, #ffffff00 100%;
}
...
:root [data-seed-color-mode="dark-only"] {
  ...
  --seed-gradient-neutral-shimmer: #ffffff00 0%, #ffffff1a 46%, #ffffff1a 54%, #ffffff00 100%;
}`
};