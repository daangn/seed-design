...
const listItem = defineSlotRecipe({
  ...
  base: {
    ...
    prefix: {
      ...
      "--seed-box-padding-right-base": vars.base.enabled.prefix.paddingRight,
    ...
    suffix: {
      ...
      "--seed-box-gap-base": vars.base.enabled.suffix.gap,
    ...
    content: {
      ...
      border: "none",
      fontFamily: "inherit",
      "--seed-box-gap-base": vars.base.enabled.content.gap,
      gap: "var(--seed-box-gap)",
      "--seed-box-padding-right-base": vars.base.enabled.content.paddingRight,
