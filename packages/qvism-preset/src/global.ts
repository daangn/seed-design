...
export const globalCss = defineGlobalCss({
  ...
  ".seed-icon": {
    ...
    verticalAlign: "var(--seed-icon-vertical-align, middle)",
  },
  ".seed-prefix-icon": {
    ...
    verticalAlign: "var(--seed-prefix-icon-vertical-align, middle)",
  ...
  ".seed-suffix-icon": {
    ...
    verticalAlign: "var(--seed-suffix-icon-vertical-align, middle)",
