...
import { generateIconComponent } from "../templates/icon-component";
import { generateIconAllComponent } from "../templates/icon-all-component";
...
export const generate = new Command("generate")
  ...
  .action((options: GenerateOptions) => {
    try {
      ...
      if (options.all) {
        seedIconComponent = generateIconAllComponent({
          componentFileName,
          version,
        });
      } else {
        seedIconComponent = generateIconComponent({
          componentFileName,
          version,
          icons,
        });
