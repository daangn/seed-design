...
export function LayoutFlexPage() {
  return (
    <scroll-view scroll-y style={{ display: "flex", flexDirection: "column", gap: "12px", flex: 1 }}>
      ...
      <text style={{ fontSize: "16px", fontWeight: "bold" }}>Direction: Row (default)</text>
      ...
      <Flex direction="row" gap="x2" justify="space-between" align="center" bg="bg.neutralWeak" p="x3" borderRadius="r2">
      ...
      <Flex direction="row" gap="x2" justify="center" bg="bg.neutralWeak" p="x3" borderRadius="r2">
        <ColorBox label="A" />
        <ColorBox label="B" />
      </Flex>
