...
declare module "@stackflow/config" {
  interface Register {
    ActivityNextListLinkItem: {};
  }
}

const ActivityNextListLinkItem: StaticActivityComponentType<"ActivityNextListLinkItem"> = () => {
  const { push } = useFlow();
  ...
  return (
    <AppScreen>
      <AppBar>
        ...
        <AppBarMain title="NextListLinkItem" />
        <AppBarRight>
...
export default ActivityNextListLinkItem;
