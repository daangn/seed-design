...
declare module "@stackflow/config" {
  interface Register {
    ActivityNextListRadioItem: {};
  }
}

const ActivityNextListRadioItem: StaticActivityComponentType<"ActivityNextListRadioItem"> = () => {
  const { push } = useFlow();
  ...
  return (
    <AppScreen>
      <AppBar>
        ...
        <AppBarMain title="NextListRadioItem" />
        <AppBarRight>
...
export default ActivityNextListRadioItem;
