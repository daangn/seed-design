...
declare module "@stackflow/config" {
  interface Register {
    ActivityLegacyAnimateFalseTest: Record<string, never>;
  }
}
...
// NextAppScreen 짝: ActivityAnimateFalseTest
const ActivityLegacyAnimateFalseTest: StaticActivityComponentType<"ActivityLegacyAnimateFalseTest"> = () => {
      ...
      <AppScreenContent>
        ...
        <VStack gap="x6" p="x5">
          ...
          <VStack gap="x3">
            ...
            <ActionButton size="large" onClick={() => push("ActivityLegacyAnimateFalseTest", {})}>
              ① push (애니 O)
            </ActionButton>
            <ActionButton
              size="large"
          ...
          <VStack gap="x3">
            ...
            <ActionButton
              size="large"
              onClick={() => push("ActivityLegacyAnimateFalseTest", {}, { animate: false })}
            >
              ① push (animate: false)
            </ActionButton>
...
export default ActivityLegacyAnimateFalseTest;
