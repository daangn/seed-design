...
declare module "@stackflow/config" {
  interface Register {
    ActivityNextListCheckItem: {};
  }
}

const ActivityNextListCheckItem: StaticActivityComponentType<"ActivityNextListCheckItem"> = () => {
  const { push } = useFlow();
  ...
  return (
    <AppScreen>
      <AppBar>
        ...
        <AppBarMain title="NextListCheckItem" />
        <AppBarRight>
...
export default ActivityNextListCheckItem;
