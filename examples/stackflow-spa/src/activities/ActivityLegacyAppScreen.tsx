...
// NextAppScreen 짝: ActivityAppScreen
const ActivityLegacyAppScreen: StaticActivityComponentType<"ActivityLegacyAppScreen"> = ({ params }) => {
  const { push } = useFlow();
            ...
            <Case label="transitionStyle">
              ...
              {appScreenVariantMap.transitionStyle.map((style) => (
                <ActionButton
                  ...
                  onClick={() => push("ActivityLegacyAppScreen", { transitionStyle: style })}
                >
...
export default ActivityLegacyAppScreen;
