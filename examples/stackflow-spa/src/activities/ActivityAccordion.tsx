        ...
        <div style={{ padding: "16px" }}>
          ...
          <Accordion variant="inline">
            <AccordionItem value="item-1">
              <AccordionTrigger>
                <AccordionTitle>당근마켓은 어떤 서비스인가요?</AccordionTitle>
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger>
                <AccordionTitle>안전하게 거래하는 방법이 있나요?</AccordionTitle>
                <AccordionDescription>직거래 안전 가이드</AccordionDescription>
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger>
                <AccordionTitle>매너온도는 무엇인가요?</AccordionTitle>
              </AccordionTrigger>
              <AccordionContent>
