...
const contentVariants = [
  ...
  { key: "title-detail", detail: "추가 설명이 포함된 스위치입니다" },
];
...
declare module "@stackflow/config" {
  interface Register {
    ActivityNextListSwitchItem: {};
  }
}

const ActivityNextListSwitchItem: StaticActivityComponentType<
  "ActivityNextListSwitchItem"
> = () => {
  const { push } = useFlow();
  ...
  return (
    <AppScreen>
      <AppBar>
        ...
        <AppBarMain title="NextListSwitchItem" />
        <AppBarRight>
...
export default ActivityNextListSwitchItem;
