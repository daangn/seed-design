...
declare module "@stackflow/config" {
  interface Register {
    ActivityLegacyPullToRefreshPreview: {};
  }
}

// Legacy AppScreen 회귀 검증 전용. 신규 activity 는 NextAppScreen 만 쓴다.
// NextAppScreen 짝: ActivityPullToRefreshPreview
const ActivityLegacyPullToRefreshPreview: StaticActivityComponentType<
  "ActivityLegacyPullToRefreshPreview"
> = () => {
...
export default ActivityLegacyPullToRefreshPreview;
