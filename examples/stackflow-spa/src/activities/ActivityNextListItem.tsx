...
declare module "@stackflow/config" {
  interface Register {
    ActivityNextListItem: {};
  }
}

const ActivityNextListItem: StaticActivityComponentType<"ActivityNextListItem"> = () => {
  const { push } = useFlow();
...
export default ActivityNextListItem;
