...
declare module "@stackflow/config" {
  interface Register {
    ActivityLegacyPullToRefreshPreventPull: {};
  }
}

// Legacy AppScreen 회귀 검증 전용. 신규 activity 는 NextAppScreen 만 쓴다.
// NextAppScreen 짝: ActivityPullToRefreshPreventPull
const ActivityLegacyPullToRefreshPreventPull: StaticActivityComponentType<
  "ActivityLegacyPullToRefreshPreventPull"
> = () => {
...
export default ActivityLegacyPullToRefreshPreventPull;
