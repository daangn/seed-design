      ...
      <SideNavigationContent>
        ...
        <SideNavigationGroup
          ...
          items={[
            ...
            { label: "목표 관리", prefixIcon: <IconFlagFill />, ...navItemProps("목표 관리") },
            {
              label: "저장된 필터",
        ...
        <SideNavigationGroup
          ...
          items={[
            ...
            { label: "알림 발송", prefixIcon: <IconBellFill />, ...navItemProps("알림 발송") },
          ]}
        />
        ...
        <SideNavigationGroup
          label="기타"
          items={[
            { label: "활동 로그", prefixIcon: <IconClockFill />, ...navItemProps("활동 로그") },
            { label: "권한 관리", prefixIcon: <IconLockFill />, ...navItemProps("권한 관리") },
          ]}
        />
      </SideNavigationContent>
