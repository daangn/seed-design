...
export interface HelpBubbleTriggerPortalProps extends HelpBubbleTriggerProps {}

export const HelpBubbleTriggerPortal = forwardRef<HTMLButtonElement, HelpBubbleTriggerPortalProps>(
  (
    {
      showCloseButton = false,
      title,
